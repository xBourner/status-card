---
title: Home
hero_title: Status Card Docs
hero_subtitle: A powerful custom card for Home Assistant Dashboards
hero_cta_primary: START INSTALLATION
hero_cta_secondary: →
hero_scroll_title: The ultimate overview.
hero_scroll_subtitle: Automatically generated, intelligently filtered, and fully responsive. Your entities, exactly as they should be.
hide:
    - navigation
    - toc    
---
...
<section class="highlights-section">
    ...
    <div class="highlights-grid">
      <div class="highlights-item reveal">
        ...
        <div class="highlights-content">
          ...
          <p>Automatically builds your dashboard from the entities and devices assigned to your Home Assistant Areas.</p>
        </div>
      </div>
      <div class="highlights-item reveal">
        <div class="highlights-icon-wrapper"><span class="highlights-icon">🔎</span></div>
        <div class="highlights-content">
          ...
          <p>Shows only active or "on" entities, with optional inverted logic for custom use cases.</p>
        </div>
      </div>
      <div class="highlights-item reveal">
        <div class="highlights-icon-wrapper"><span class="highlights-icon">🧩</span></div>
        <div class="highlights-content">
          ...
          <p>Organizes active entities by domain or device_class for clear, structured views.</p>
        </div>
      </div>
      <div class="highlights-item reveal">
        <div class="highlights-icon-wrapper"><span class="highlights-icon">🧠</span></div>
        <div class="highlights-content">
          ...
          <p>Build intelligent groups with multi-layered filters by state, domain, and more.</p>
        </div>
      </div>
      <div class="highlights-item reveal">
        <div class="highlights-icon-wrapper"><span class="highlights-icon">➕</span></div>
        <div class="highlights-content">
          ...
          <p>Add missing entities manually or hide specific ones you don't want to see.</p>
        </div>
      </div>
      <div class="highlights-item reveal">
        <div class="highlights-icon-wrapper"><span class="highlights-icon">💬</span></div>
        <div class="highlights-content">
          ...
          <p>Tap any group to open a native popup showing all contained entities as interactive Tile Cards.</p>
        </div>
      </div>
    </div>
    ...
    <section class="hero-preview-section">
      <div class="hero-preview-grid">
        <div class="hero-preview-card reveal" style="transition-delay: 0.1s;">
          <img src="https://raw.githubusercontent.com/xbourner/status-card/main/.github/img/status-card-light.png" alt="Status Card preview light theme" loading="lazy">
        </div>
        <div class="hero-preview-card reveal" style="transition-delay: 0.25s;">
          <img src="https://raw.githubusercontent.com/xbourner/status-card/main/.github/img/status-card-dark.png" alt="Status Card preview dark theme" loading="lazy">
        </div>
      </div>
    </section>
  </div>
  ...
  <div class="showcase-container">
    <div class="showcase-item align-center">
      ...
      <p class="showcase-text reveal" style="margin: 0 auto; transition-delay: 0.2s;">
    ...
    <div class="showcase-item align-center">
      ...
      <div class="reveal" style="transition-delay: 0.2s; margin-top: 1.5rem;">
        <div class="video-buttons u-btn-group" style="justify-content: center; margin: 0 auto;">
