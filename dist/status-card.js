 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: K1, defineProperty: Y1, getOwnPropertyDescriptor: J1, getOwnPropertyNames: X1, getOwnPropertySymbols: Q1, getPrototypeOf: ti } = Object, et = globalThis, He = et.trustedTypes, ei = He ? He.emptyScript : "", Ft = et.reactiveElementPolyfillSupport, yt = (e, t) => e, Tt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? ei : null;
      break;
  ...
  return i;
} }, ue = (e, t) => !K1(e, t), Ve = { attribute: !0, type: String, converter: Tt, reflect: !1, useDefault: !1, hasChanged: ue };
...
let pt = class extends HTMLElement {
  ...
  _$AK(t, i) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const c = s.getPropertyOptions(o), r = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((n = c.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? c.converter : Tt;
      this._$Em = o;
...
pt.elementStyles = [], pt.shadowRootOptions = { mode: "open" }, pt[yt("elementProperties")] = /* @__PURE__ */ new Map(), pt[yt("finalized")] = /* @__PURE__ */ new Map(), Ft == null || Ft({ ReactiveElement: pt }), (et.reactiveElementVersions ?? (et.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const vt = globalThis, It = vt.trustedTypes, $e = It ? It.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, E1 = "$lit$", Q = `lit$${Math.random().toFixed(9).slice(2)}$`, S1 = "?" + Q, ii = `<${S1}>`, lt = document, bt = () => lt.createComment(""), Lt = (e) => e === null || typeof e != "object" && typeof e != "function", pe = Array.isArray, si = (e) => pe(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Nt = `[ 	
\f\r]`, gt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Me = /-->/g, we = />/g, nt = RegExp(`>|${Nt}(?:([^\\s"'>=/]+)(${Nt}*=${Nt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ee = /'/g, Se = /"/g, x1 = /^(?:script|style|textarea|title)$/i, oi = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), g = oi(1), U = Symbol.for("lit-noChange"), D = Symbol.for("lit-nothing"), xe = /* @__PURE__ */ new WeakMap(), rt = lt.createTreeWalker(lt, 129);
function z1(e, t) {
...
const ni = (e, t) => {
  ...
  for (let c = 0; c < i; c++) {
    const r = e[c];
    let l, d, h = -1, f = 0;
    for (; f < r.length && (a.lastIndex = f, d = a.exec(r), d !== null); ) f = a.lastIndex, a === gt ? d[1] === "!--" ? a = Me : d[1] !== void 0 ? a = we : d[2] !== void 0 ? (x1.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = nt) : d[3] !== void 0 && (a = nt) : a === nt ? d[0] === ">" ? (a = o ?? gt, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, l = d[1], a = d[3] === void 0 ? nt : d[3] === '"' ? Se : Ee) : a === Se || a === Ee ? a = nt : a === Me || a === we ? a = gt : (a = nt, o = void 0);
    const u = a === nt && e[c + 1].startsWith("/>") ? " " : "";
    n += a === gt ? r + ii : h >= 0 ? (s.push(l), r.slice(0, h) + E1 + r.slice(h) + Q + u) : r + Q + (h === -2 ? c : u);
  }
  return [z1(e, n + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), s];
};
class At {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const c = t.length - 1, r = this.parts, [l, d] = ni(t, i);
    ...
    for (; (o = rt.nextNode()) !== null && r.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(E1)) {
          ...
          r.push({ type: 1, index: n, name: m[2], strings: u, ctor: m[1] === "." ? ri : m[1] === "?" ? ci : m[1] === "@" ? li : Zt }), o.removeAttribute(h);
        ...
        if (x1.test(o.tagName)) {
          ...
          if (f > 0) {
            ...
            for (let u = 0; u < f; u++) o.append(h[u], bt()), rt.nextNode(), r.push({ type: 2, index: ++n });
            o.append(h[f], bt());
          }
        }
...
function ft(e, t, i = e, s) {
  ...
  return (o == null ? void 0 : o.constructor) !== n && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), n === void 0 ? o = void 0 : (o = new n(e), o._$AT(e, i, s)), s !== void 0 ? (i._$Co ?? (i._$Co = []))[s] = o : i._$Cl = o), o !== void 0 && (t = ft(e, o._$AS(e, t.values), o, s)), t;
}
let ai = class {
  constructor(t, i) {
  ...
  u(t) {
    ...
    for (; r !== void 0; ) {
      if (a === r.index) {
        let l;
        r.type === 2 ? l = new mt(n, n.nextSibling, this, t) : r.type === 1 ? l = new r.ctor(n, r.name, r.strings, this, t) : r.type === 6 && (l = new di(n, this, t)), this._$AV.push(l), r = s[++c];
      }
...
class mt {
  ...
  _$AI(t, i = this) {
    t = ft(this, t, i), Lt(t) ? t === D || t == null || t === "" ? (this._$AH !== D && this._$AR(), this._$AH = D) : t !== this._$AH && t !== U && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : si(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== D && Lt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(lt.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
    const { values: i, _$litType$: s } = t, o = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = At.createElement(z1(s.h, s.h[0]), this.options)), s);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(i);
    else {
      const a = new ai(o, this), c = a.u(this.options);
      a.p(i), this.T(c), this._$AH = a;
    }
  }
  _$AC(t) {
    let i = xe.get(t.strings);
    return i === void 0 && xe.set(t.strings, i = new At(t)), i;
  }
  k(t) {
    pe(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let s, o = 0;
    for (const n of t) o === i.length ? i.push(s = new mt(this.O(bt()), this.O(bt()), this, this.options)) : s = i[o], s._$AI(n), o++;
...
class Zt {
  ...
  _$AI(t, i = this, s, o) {
    ...
    let a = !1;
    if (n === void 0) t = ft(this, t, i, 0), a = !Lt(t) || t !== this._$AH && t !== U, a && (this._$AH = t);
    else {
      const c = t;
      let r, l;
      for (t = n[0], r = 0; r < n.length - 1; r++) l = ft(this, c[s + r], i, r), l === U && (l = this._$AH[r]), a || (a = !Lt(l) || l !== this._$AH[r]), l === D ? t = D : t !== D && (t += (l ?? "") + n[r + 1]), this._$AH[r] = l;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const hi = { I: mt }, Ut = vt.litHtmlPolyfillSupport;
Ut == null || Ut(At, mt), (vt.litHtmlVersions ?? (vt.litHtmlVersions = [])).push("3.3.1");
const ui = (e, t, i) => {
  const s = (i == null ? void 0 : i.renderBefore) ?? t;
  let o = s._$litPart$;
  if (o === void 0) {
    const n = (i == null ? void 0 : i.renderBefore) ?? null;
    s._$litPart$ = o = new mt(t.insertBefore(bt(), n), n, void 0, i ?? {});
  }
  return o._$AI(e), o;
};
/**
...
var M1;
N._$litElement$ = !0, N.finalized = !0, (M1 = ct.litElementHydrateSupport) == null || M1.call(ct, { LitElement: N });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pi = { attribute: !0, type: String, converter: Tt, reflect: !1, hasChanged: ue }, fi = (e = pi, t, i) => {
...
const { I: _i } = hi, ze = () => document.createComment(""), Ct = (e, t, i) => {
  ...
  return i;
}, at = (e, t, i = e) => (e._$AI(t, i), e), mi = {}, gi = (e, t = mi) => e._$AH = t, Ci = (e) => e._$AH, qt = (e) => {
...
const ke = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    ...
    else if (c[h] === a[m]) r[m] = at(o[h], n[m]), Ct(e, r[m + 1], o[h]), h++, m--;
    else if (c[f] === a[u]) r[u] = at(o[f], n[u]), Ct(e, o[h], o[f]), f--, u++;
    else if (l === void 0 && (l = ke(a, u, m), d = ke(c, h, f)), l.has(c[h])) if (l.has(c[f])) {
      const y = d.get(a[u]), _ = y !== void 0 ? o[y] : null;
      if (_ === null) {
        const p = Ct(e, o[h]);
        at(p, n[u]), r[u] = p;
      } else r[u] = at(_, n[u]), Ct(e, o[h], _), o[y] = null;
      u++;
    } else qt(o[f]), f--;
    else qt(o[h]), h++;
    for (; u <= m; ) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const k1 = "important", yi = " !" + k1, z = Rt(class extends Bt {
  constructor(e) {
    var t;
...
}, T = (e) => e.substr(0, e.indexOf(".")), co = (e) => (t, i) => e.includes(t, i), me = "unavailable", lo = "unknown", ho = "off", uo = [me, lo], po = co(uo), fo = (e) => {
...
), Ho = (e, t) => e < t ? -1 : e > t ? 1 : 0, D1 = (e, t, i = void 0) => Intl != null && Intl.Collator ? Ao(i).compare(e, t) : Ho(e.toLowerCase(), t.toLowerCase()), Ot = (e, t) => {
  if (e === t)
    return !0;
...
customElements.define("action-handler-status-card", Vo);
const $o = () => {
...
const F = {
  ...
  lock: { on: s1, off: i1 },
  light: { on: ls, off: ds },
  media_player: { on: Gi, off: Ri },
  climate: { on: Fs, off: Ns },
  ...
  binary_sensor: {
    ...
    off: Xt,
    motion: { on: _s, off: ms },
    moisture: { on: Qs, off: eo },
    window: { on: b1, off: v1 },
    door: { on: Ke, off: qe },
    lock: { on: s1, off: i1 },
    presence: { on: as, off: ns },
    occupancy: { on: ks, off: Ds },
    vibration: { on: Js, off: Xs },
  ...
  person: { on: Oe, off: Te },
  device_tracker: { on: Oe, off: Te },
  valve: { on: Ks, off: _1 },
  water_heater: { on: to, off: io },
  remote: { on: Vs, off: $s },
  update: { on: Pe, off: Ze },
...
var Zo = Object.defineProperty, O = (e, t, i, s) => {
...
const Ce = class Ce extends N {
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return n.sort((r, l) => {
            ...
            if (d !== h) return d - h;
            const f = T(r.entity_id), u = T(l.entity_id), m = this.hass ? W(this.hass, r.state, f) : r.state, y = this.hass ? W(this.hass, l.state, u) : l.state, _ = (m || "").localeCompare(y || "");
  ...
  _getPopupCardConfig(t) {
    ...
    const s = T(t.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (C = (b = (p = (_ = this.hass) == null ? void 0 : _.states) == null ? void 0 : p[t.entity_id]) == null ? void 0 : b.attributes) == null ? void 0 : C.device_class, a = R(o, n), c = typeof (i == null ? void 0 : i.getCustomizationForType) == "function" ? i.getCustomizationForType(a) : void 0, r = c == null ? void 0 : c.popup_card, l = r && typeof r.type == "string" && r.type || "tile", d = l === "tile" ? Oo[s] ?? {} : {};
    let h = {};
  ...
  _isEntityActive(t) {
    var r;
    const i = this.selectedDomain || T(t.entity_id), s = this.selectedDeviceClass || t.attributes.device_class, o = R(i, s), n = typeof ((r = this.card) == null ? void 0 : r.getCustomizationForType) == "function" ? this.card.getCustomizationForType(o) : void 0, a = (n == null ? void 0 : n.invert) === !0;
    if (i === "climate") {
...
const G = (e, t) => e ? typeof e == "object" ? Object.entries(e).reduce((o, [n, a]) => {
  ...
  return o;
}, {})) : {}, se = (e, t, i) => t && t._parsedCss ? t._parsedCss : e ? G(e) : {}, Go = _t`
...
function oe(e, t, i, s, o, n, a, c) {
  const r = R(i, s), l = $t(t, r, c), d = (l == null ? void 0 : l.invert) === !0;
  switch (i) {
    case "device_tracker":
      return Bo(e, d);
    case "lock":
...
const Uo = (e, t, i, s) => s ? [] : Object.values(e).filter(
  ...
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    const r = s.indexOf(n), l = r >= 0 ? r : 0, d = Z1(
      e,
      n,
      void 0,
      a,
      i
    ), h = re(e, n, void 0, a, i) ?? a.attributes.friendly_name ?? n, f = Mt(
      e,
      "icon_color",
      n,
      void 0,
      i
    ) || ((c == null ? void 0 : c.activate_state_color) ?? e.activate_state_color ? Lo(a) : void 0) || e.color, u = Ro(
      e,
      n,
      void 0,
      i
...
}).filter((i) => !!i), Yo = (e) => e.map(
  (t, i) => t.includes(" - ") ? null : {
    type: "domain",
    domain: t.trim().toLowerCase().replace(/\s+/g, "_"),
    order: i
  }
).filter((t) => t !== null), Jo = (e) => e.map((t, i) => {
...
function Xo(e, t, i, s, o) {
  var f;
  const n = e.__registryEntities || [], a = e.__registryDevices || [], c = e.__registryAreas || [], r = i || new Map(n.map((u) => [u.entity_id, u])), l = s || new Map(a.map((u) => [u.id, u])), d = o || new Map(c.map((u) => [u.area_id, u])), h = R1(
    t,
    n,
    a,
    c,
...
function j1(e, t, i, s) {
  var a, c;
  const o = ((a = s.entityMap) == null ? void 0 : a.get(t.entity_id)) || ((c = s.entities) == null ? void 0 : c.find((r) => r.entity_id === t.entity_id)), n = Qo[i.key];
...
let w = class extends N {
  constructor() {
    ...
    ), this._customizationIndexMemo = M(P1), this._computePersonIdsMemo = M(Uo), this._mapPersonIdsToStatesMemo = M(
      (e, t) => Wo(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
    ...
    ), this._computeGroupItemsMemo = M(Ko), this._computeDomainItemsMemo = M(Yo), this._computeDeviceClassItemsMemo = M(Jo), this._computeEntityMap = M(
  ...
  updated(e) {
    ...
    (e.has("hass") && (!t || t.themes !== this.hass.themes) || e.has("_config") && (!i || i.theme !== this._config.theme)) && ro(
      this,
      this.hass.themes,
      this._config.theme
    );
  ...
  renderGroupTab(e, t) {
    ...
    const n = e.group_id || `${this.hass.localize("component.group.entity_component._.name")} ${t + 1}`, a = e.group_icon || Xi, c = $1(
      this._config,
      n,
      void 0,
      this._customizationIndexMemo(this._config.customization)
      ...
      background_color: r,
      square: this._config.square
    }), u = this.getCustomizationForType(n), m = (u == null ? void 0 : u.badge_color) || this.badge_color || void 0, y = (u == null ? void 0 : u.badge_text_color) || this.badge_text_color || void 0, _ = {
      "--status-card-badge-color": m ? `var(--${m}-color)` : void 0,
      "--status-card-badge-text-color": y ? `var(--${y}-color)` : void 0
    }, p = se(
      ((V = u == null ? void 0 : u.styles) == null ? void 0 : V.button) || ((S = u == null ? void 0 : u.styles) == null ? void 0 : S.card),
      u
    ), b = { ...this._parsedGlobalCss, ...p }, C = (u == null ? void 0 : u._parsedIconCss) || G((x = u == null ? void 0 : u.styles) == null ? void 0 : x.icon), L = {
      ...this._parsedGlobalIconCss,
      ...C
    }, v = (u == null ? void 0 : u.badge_mode) ?? this.badge_mode;
    return g`
      <ha-tab-group-tab
        slot="nav"
        panel=${"group-" + t}
...
function nn(e, t, i, s, o) {
  const n = (d, h, f) => Vt(e, d, h, f), a = n({ name: "area" }), c = n({ name: "floor" }), r = n({ name: "name" }), l = n({ name: "state" });
  return [
    {
      name: "person",
      // @ts-ignore
