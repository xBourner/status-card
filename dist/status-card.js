 ...
 */
const kt = globalThis, ce = kt.ShadowRoot && (kt.ShadyCSS === void 0 || kt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, de = Symbol(), Ce = /* @__PURE__ */ new WeakMap();
let L1 = class {
  constructor(t, i, s) {
  ...
  get styleSheet() {
    ...
    if (ce && t === void 0) {
      ...
      s && (t = Ce.get(i)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), s && Ce.set(i, t));
    }
    return t;
  }
  toString() {
...
}, ye = ce ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: G1, defineProperty: F1, getOwnPropertyDescriptor: U1, getOwnPropertyNames: N1, getOwnPropertySymbols: W1, getPrototypeOf: q1 } = Object, et = globalThis, ve = et.trustedTypes, K1 = ve ? ve.emptyScript : "", Gt = et.reactiveElementPolyfillSupport, Ct = (e, t) => e, Dt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? K1 : null;
      break;
  ...
  return i;
} }, he = (e, t) => !G1(e, t), be = { attribute: !0, type: String, converter: Dt, reflect: !1, useDefault: !1, hasChanged: he };
...
let ut = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Ct("properties"))) {
      const i = this.properties, s = [...N1(i), ...W1(i)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of s) i.unshift(ye(o));
  ...
  _$AK(t, i) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const l = s.getPropertyOptions(o), r = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((n = l.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? l.converter : Dt;
      this._$Em = o;
  ...
  requestUpdate(t, i, s) {
    ...
    if (t !== void 0) {
      ...
      if (s ?? (s = n.getPropertyOptions(t)), !((s.hasChanged ?? he)(a, i) || s.useDefault && s.reflect && a === ((o = this._$Ej) == null ? void 0 : o.get(t)) && !this.hasAttribute(n._$Eu(t, s)))) return;
      this.C(t, i, s);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const yt = globalThis, Tt = yt.trustedTypes, Le = Tt ? Tt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, A1 = "$lit$", Q = `lit$${Math.random().toFixed(9).slice(2)}$`, H1 = "?" + Q, Y1 = `<${H1}>`, lt = document, vt = () => lt.createComment(""), bt = (e) => e === null || typeof e != "object" && typeof e != "function", ue = Array.isArray, J1 = (e) => ue(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ft = `[ 	
\f\r]`, mt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ae = /-->/g, He = />/g, ot = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ve = /'/g, $e = /"/g, V1 = /^(?:script|style|textarea|title)$/i, X1 = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), g = X1(1), U = Symbol.for("lit-noChange"), z = Symbol.for("lit-nothing"), Me = /* @__PURE__ */ new WeakMap(), at = lt.createTreeWalker(lt, 129);
function $1(e, t) {
...
const Q1 = (e, t) => {
  ...
  for (let l = 0; l < i; l++) {
    const r = e[l];
    let c, d, h = -1, _ = 0;
    for (; _ < r.length && (a.lastIndex = _, d = a.exec(r), d !== null); ) _ = a.lastIndex, a === mt ? d[1] === "!--" ? a = Ae : d[1] !== void 0 ? a = He : d[2] !== void 0 ? (V1.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = ot) : d[3] !== void 0 && (a = ot) : a === ot ? d[0] === ">" ? (a = o ?? mt, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, c = d[1], a = d[3] === void 0 ? ot : d[3] === '"' ? $e : Ve) : a === $e || a === Ve ? a = ot : a === Ae || a === He ? a = mt : (a = ot, o = void 0);
    ...
    for (; (o = at.nextNode()) !== null && r.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(A1)) {
          ...
          r.push({ type: 1, index: n, name: f[2], strings: u, ctor: f[1] === "." ? ei : f[1] === "?" ? ii : f[1] === "@" ? si : Pt }), o.removeAttribute(h);
...
class _t {
  ...
  _$AI(t, i = this) {
    t = pt(this, t, i), bt(t) ? t === z || t == null || t === "" ? (this._$AH !== z && this._$AR(), this._$AH = z) : t !== this._$AH && t !== U && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : J1(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _$AC(t) {
    ...
    return i === void 0 && Me.set(t.strings, i = new Lt(t)), i;
  }
  k(t) {
...
class Pt {
  ...
  _$AI(t, i = this, s, o) {
    ...
    let a = !1;
    if (n === void 0) t = pt(this, t, i, 0), a = !bt(t) || t !== this._$AH && t !== U, a && (this._$AH = t);
    else {
      const l = t;
      let r, c;
      for (t = n[0], r = 0; r < n.length - 1; r++) c = pt(this, l[s + r], i, r), c === U && (c = this._$AH[r]), a || (a = !bt(c) || c !== this._$AH[r]), c === z ? t = z : t !== z && (t += (c ?? "") + n[r + 1]), this._$AH[r] = c;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
var b1;
F._$litElement$ = !0, F.finalized = !0, (b1 = rt.litElementHydrateSupport) == null || b1.call(rt, { LitElement: F });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ri = { attribute: !0, type: String, converter: Dt, reflect: !1, hasChanged: he }, li = (e = ri, t, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pe = { ATTRIBUTE: 1, CHILD: 2 }, jt = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Rt = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: ci } = ni, we = () => document.createComment(""), gt = (e, t, i) => {
  var n;
  const s = e._$AA.parentNode, o = t === void 0 ? e._$AB : t._$AA;
  if (i === void 0) {
    const a = s.insertBefore(we(), o), l = s.insertBefore(we(), o);
  ...
  return i;
}, nt = (e, t, i = e) => (e._$AI(t, i), e), di = {}, hi = (e, t = di) => e._$AH = t, ui = (e) => e._$AH, Wt = (e) => {
...
const Ee = (e, t, i) => {
  ...
  return s;
}, tt = jt(class extends Rt {
  constructor(e) {
    if (super(e), e.type !== pe.CHILD) throw Error("repeat() can only be used in text expressions");
  }
  dt(e, t, i) {
    let s;
  ...
  update(e, [t, i, s]) {
    ...
    else if (c === void 0 && (c = Ee(a, u, f), d = Ee(l, h, _)), c.has(l[h])) if (c.has(l[_])) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ht = jt(class extends Rt {
  constructor(e) {
    var t;
    if (super(e), e.type !== pe.ATTRIBUTE || e.name !== "class" || ((t = e.strings) == null ? void 0 : t.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M1 = "important", pi = " !" + M1, S = jt(class extends Rt {
  constructor(e) {
    var t;
    if (super(e), e.type !== pe.ATTRIBUTE || e.name !== "style" || ((t = e.strings) == null ? void 0 : t.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
  }
  render(e) {
...
}, G = (e) => e.substr(0, e.indexOf(".")), io = (e) => {
  const t = G(e.entity_id), i = e.state;
  if (t === "light" && i === "on") {
...
), oo = (e, t) => e < t ? -1 : e > t ? 1 : 0, w1 = (e, t, i = void 0) => Intl != null && Intl.Collator ? so(i).compare(e, t) : oo(e.toLowerCase(), t.toLowerCase()), Ot = (e, t) => {
  if (e === t)
    return !0;
...
customElements.define("action-handler-status-card", no);
const ao = () => {
...
const B = {
  ...
  binary_sensor: {
    ...
    gas: { on: Ki, off: qi },
    carbon_monoxide: { on: i1, off: i1 },
    cold: { on: Ds, off: Ts },
    heat: { on: _1, off: Xs },
    connectivity: { on: Be, off: Be },
    safety: { on: Es, off: Ss },
    sound: { on: u1, off: p1 },
    update: { on: Oe, off: De },
    tamper: { on: l1, off: l1 },
  ...
  person: { on: xe, off: ze },
  device_tracker: { on: xe, off: ze },
  valve: { on: Gs, off: h1 },
  water_heater: { on: qs, off: Ys },
  remote: { on: ys, off: vs },
  update: { on: Oe, off: De },
  air_quality: { on: ke, off: ke },
  camera: { on: Si, off: xi },
  calendar: { on: Pe, off: Ze },
  scene: { on: hs, off: us },
  notifications: { on: $i, off: Ie },
  sensor: { on: qe, off: qe },
  script: { on: r1, off: r1 },
  tags: { on: c1, off: c1 },
  select: { on: wt, off: wt },
  ...
  button: { on: Ke, off: Ke },
  number: { on: Et, off: Et },
  conversation: { on: Re, off: Re },
  assist_satellite: {
    on: a1,
    off: a1
  },
  counter: { on: Ge, off: Ge },
  event: { on: je, off: je },
  group: {
    on: Ye,
    off: Ye
  ...
  weather: { on: Js, off: f1 },
  zone: { on: t1, off: e1 },
  geo_location: { on: t1, off: e1 }
}, X = [
  "alarm_control_panel",
  "siren",
  "lock",
...
function yo(e, t) {
  ...
  for (const [i, s] of Object.entries(_o))
    if (s.includes(t))
      return e.localize(
...
function Ht(e, t, i, s) {
  ...
  if (t.name === "header")
    return Co(e, i, s);
  const o = go[t.name];
  return o ? o(e) : yo(e, t.name);
}
var vo = Object.defineProperty, D = (e, t, i, s) => {
...
const me = class me extends F {
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return n.sort((r, c) => {
            ...
            if (d !== h) return d - h;
            const _ = G(r.entity_id), u = G(c.entity_id), f = this.hass ? N(this.hass, r.state, _) : r.state, y = this.hass ? N(this.hass, c.state, u) : c.state, m = (f || "").localeCompare(y || "");
  ...
  _isEntityActive(t) {
    var r;
    const i = this.selectedDomain || G(t.entity_id), s = this.selectedDeviceClass || t.attributes.device_class, o = j(i, s), n = typeof ((r = this.card) == null ? void 0 : r.getCustomizationForType) == "function" ? this.card.getCustomizationForType(o) : void 0, a = (n == null ? void 0 : n.invert) === !0;
    if (i === "climate") {
...
const Z = (e, t) => e ? typeof e == "object" ? Object.entries(e).reduce((o, [n, a]) => {
  ...
  return o;
}, {})) : {}, ie = (e, t, i) => t && t._parsedCss ? t._parsedCss : e ? Z(e) : {}, bo = ft`
...
function $o(e, t = {}) {
  const { color: i, background_color: s, square: o, isNotHome: n } = t, a = {
    ...
    "background-color": s,
    color: i ? i.startsWith("rgb") || i.startsWith("#") || i.startsWith("hsl") ? i : `var(--${i}-color)` : void 0
  };
  return e === "person" && n && (a.filter = "grayscale(100%)"), a;
}
const Mo = (e, t, i, s) => s ? [] : Object.values(e).filter(
  (o) => {
    var n;
    return o.entity_id.startsWith("person.") && !t.includes(o.entity_id) && !((n = o.labels) != null && n.some((a) => i.includes(a))) && !o.hidden;
  }
).map((o) => o.entity_id).reverse(), wo = (e, t) => e.map((i) => t[i]).filter((i) => !!i), Eo = (e, t, i) => {
  const s = e.content || [];
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    const r = s.indexOf(n), c = r >= 0 ? r : 0, d = k1(
      ...
      a,
      i
    ), h = ae(e, n, void 0, a, i) ?? a.attributes.friendly_name ?? n, _ = $t(
      e,
      "icon_color",
      n,
      void 0,
      i
    ) || (l != null && l.activate_state_color ? io(a) : void 0) || e.color, u = Lo(
      e,
      n,
      void 0,
      i
...
).filter((t) => t !== null), zo = (e) => e.map((t, i) => {
  ...
  if (Array.isArray(e.filters))
    r = e.filters.filter((c) => re.includes(c.key));
  else {
    const c = e;
    re.forEach((d) => {
  ...
  if (Array.isArray(t.filters))
    l = t.filters.filter((r) => !re.includes(r.key));
  else {
    const r = t;
    [
      "state",
...
function I1(e, t, i, s) {
  var a, l;
  const o = ((a = s.entityMap) == null ? void 0 : a.get(t.entity_id)) || ((l = s.entities) == null ? void 0 : l.find((r) => r.entity_id === t.entity_id)), n = Oo[i.key];
...
function To(e, t, i, s, o, n, a) {
  n.stopPropagation();
  const l = n.detail.action, r = zt(i, l, s, o), c = typeof r == "string" && r === "more-info" || typeof r == "object" && (r == null ? void 0 : r.action) === "more-info", d = typeof r == "string" && r === "toggle" || typeof r == "object" && (r == null ? void 0 : r.action) === "toggle";
  if (s.includes(".")) {
    const h = s, _ = G(h);
    if (d) {
...
var Io = Object.defineProperty, Po = Object.getOwnPropertyDescriptor, w = (e, t, i, s) => {
...
let $ = class extends F {
  constructor() {
    ...
    ), this._customizationIndexMemo = V(z1), this._computePersonIdsMemo = V(Mo), this._mapPersonIdsToStatesMemo = V(
      (e, t) => wo(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
    ...
    ), this._computeGroupItemsMemo = V(So), this._computeDomainItemsMemo = V(xo), this._computeDeviceClassItemsMemo = V(zo), this._computeEntityMap = V(
  ...
  _openDomainPopup(e) {
    var a, l, r;
    let t = "Details";
    typeof e == "string" ? t = ae(this._config, e) || this.computeLabel({ name: e }) : typeof e == "number" && ((a = this._config.content) != null && a[e]) && (t = this._config.content[e]);
    let i = [], s = [];
    if (typeof e == "number") {
  ...
  renderExtraTab(e) {
    ...
    }), u = (r == null ? void 0 : r.state_content) ?? "state", f = (r == null ? void 0 : r.badge_mode) ?? this.badge_mode, y = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, m = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, p = {
  ...
  renderGroupTab(e, t) {
    ...
    const n = e.group_id || `${this.hass.localize("component.group.entity_component._.name")} ${t + 1}`, a = e.group_icon || Ni, l = v1(
      this._config,
      n,
      void 0,
      this._customizationIndexMemo(this._config.customization)
      ...
      f
    ), m = { ...this._parsedGlobalCss, ...y }, p = (f == null ? void 0 : f._parsedIconCss) || Z((A = f == null ? void 0 : f.styles) == null ? void 0 : A.icon), b = {
      ...this._parsedGlobalIconCss,
      ...p
    };
    return g`
  ...
  renderItemTab(e) {
    ...
    const l = v1(
      ...
      square: this._config.square
    }), u = ae(this._config, t, i) || this.computeLabel({ name: i || t });
    let f;
...
var No = Object.defineProperty, Wo = Object.getOwnPropertyDescriptor, Y = (e, t, i, s) => {
  for (var o = s > 1 ? void 0 : s ? Wo(t, i) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (s ? a(t, i, o) : a(o)) || o);
  return s && o && No(t, i, o), o;
};
...
var qo = Object.defineProperty, Ko = Object.getOwnPropertyDescriptor, Bt = (e, t, i, s) => {
  for (var o = s > 1 ? void 0 : s ? Ko(t, i) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (s ? a(t, i, o) : a(o)) || o);
...
var Yo = Object.defineProperty, Jo = Object.getOwnPropertyDescriptor, st = (e, t, i, s) => {
  for (var o = s > 1 ? void 0 : s ? Jo(t, i) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (s ? a(t, i, o) : a(o)) || o);
  return s && o && Yo(t, i, o), o;
};
let K = class extends F {
  ...
  _classesForArea(e, t, i, s, o, n) {
    var _;
    const a = ((_ = this._config) == null ? void 0 : _.extra_entities) || [], l = C1(
      s,
      o,
      n,
      this.hass.states,
        ...
        (a) => {
          ...
          return g`
                                      <div class="entity-row">
                                        ...
                                        <ha-icon-button
                                          .path=${this._isHiddenEntity(a) ? We : Ne}
