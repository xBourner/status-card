...
const R1 = (e) => new L1(typeof e == "string" ? e : e + "", void 0, he), ft = (e, ...t) => {
...
ut.elementStyles = [], ut.shadowRootOptions = { mode: "open" }, ut[Ct("elementProperties")] = /* @__PURE__ */ new Map(), ut[Ct("finalized")] = /* @__PURE__ */ new Map(), Gt == null || Gt({ ReactiveElement: ut }), (et.reactiveElementVersions ?? (et.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
\f\r]`, _t = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, He = /-->/g, Ve = />/g, ot = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
...
const Q1 = (e, t) => {
  ...
  for (let l = 0; l < i; l++) {
    const r = e[l];
    let c, d, h = -1, m = 0;
    for (; m < r.length && (a.lastIndex = m, d = a.exec(r), d !== null); ) m = a.lastIndex, a === _t ? d[1] === "!--" ? a = He : d[1] !== void 0 ? a = Ve : d[2] !== void 0 ? (V1.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = ot) : d[3] !== void 0 && (a = ot) : a === ot ? d[0] === ">" ? (a = o ?? _t, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, c = d[1], a = d[3] === void 0 ? ot : d[3] === '"' ? Me : $e) : a === Me || a === $e ? a = ot : a === He || a === Ve ? a = _t : (a = ot, o = void 0);
    const u = a === ot && e[l + 1].startsWith("/>") ? " " : "";
    n += a === _t ? r + Y1 : h >= 0 ? (s.push(c), r.slice(0, h) + A1 + r.slice(h) + Q + u) : r + Q + (h === -2 ? l : u);
  }
    ...
    for (; (o = at.nextNode()) !== null && r.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(A1)) {
          const m = d[a++], u = o.getAttribute(h).split(Q), f = /([.?@])?(.*)/.exec(m);
        ...
        if (V1.test(o.tagName)) {
          const h = o.textContent.split(Q), m = h.length - 1;
          if (m > 0) {
            o.textContent = Dt ? Dt.emptyScript : "";
            for (let u = 0; u < m; u++) o.append(h[u], vt()), at.nextNode(), r.push({ type: 2, index: ++n });
            o.append(h[m], vt());
          }
        }
...
function pt(e, t, i = e, s) {
  ...
  return (o == null ? void 0 : o.constructor) !== n && ((l = o == null ? void 0 : o._$AO) == null || l.call(o, !1), n === void 0 ? o = void 0 : (o = new n(e), o._$AT(e, i, s)), s !== void 0 ? (i._$Co ?? (i._$Co = []))[s] = o : i._$Cl = o), o !== void 0 && (t = pt(e, o._$AS(e, t.values), o, s)), t;
}
let ti = class {
  constructor(t, i) {
  ...
  u(t) {
    ...
    for (; r !== void 0; ) {
      if (a === r.index) {
        let c;
        r.type === 2 ? c = new mt(n, n.nextSibling, this, t) : r.type === 1 ? c = new r.ctor(n, r.name, r.strings, this, t) : r.type === 6 && (c = new oi(n, this, t)), this._$AV.push(c), r = s[++l];
      }
...
class mt {
  ...
  _$AI(t, i = this) {
    t = pt(this, t, i), bt(t) ? t === z || t == null || t === "" ? (this._$AH !== z && this._$AR(), this._$AH = z) : t !== this._$AH && t !== F && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : J1(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  k(t) {
    ...
    const i = this._$AH;
    let s, o = 0;
    for (const n of t) o === i.length ? i.push(s = new mt(this.O(vt()), this.O(vt()), this, this.options)) : s = i[o], s._$AI(n), o++;
...
class It {
  ...
  _$AI(t, i = this, s, o) {
    ...
    let a = !1;
    if (n === void 0) t = pt(this, t, i, 0), a = !bt(t) || t !== this._$AH && t !== F, a && (this._$AH = t);
    else {
      const l = t;
      let r, c;
      for (t = n[0], r = 0; r < n.length - 1; r++) c = pt(this, l[s + r], i, r), c === F && (c = this._$AH[r]), a || (a = !bt(c) || c !== this._$AH[r]), c === z ? t = z : t !== z && (t += (c ?? "") + n[r + 1]), this._$AH[r] = c;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const ni = { I: mt }, Ut = yt.litHtmlPolyfillSupport;
Ut == null || Ut(Lt, mt), (yt.litHtmlVersions ?? (yt.litHtmlVersions = [])).push("3.3.1");
const ai = (e, t, i) => {
  const s = (i == null ? void 0 : i.renderBefore) ?? t;
  let o = s._$litPart$;
  if (o === void 0) {
    const n = (i == null ? void 0 : i.renderBefore) ?? null;
    s._$litPart$ = o = new mt(t.insertBefore(vt(), n), n, void 0, i ?? {});
  }
  return o._$AI(e), o;
};
/**
...
const Se = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    ...
    let c, d, h = 0, m = o.length - 1, u = 0, f = n.length - 1;
    for (; h <= m && u <= f; ) if (o[h] === null) h++;
    else if (o[m] === null) m--;
    else if (l[h] === a[u]) r[u] = nt(o[h], n[u]), h++, u++;
    else if (l[m] === a[f]) r[f] = nt(o[m], n[f]), m--, f--;
    else if (l[h] === a[f]) r[f] = nt(o[h], n[f]), gt(e, r[f + 1], o[h]), h++, f--;
    else if (l[m] === a[u]) r[u] = nt(o[m], n[u]), gt(e, o[h], o[m]), m--, u++;
    else if (c === void 0 && (c = Se(a, u, f), d = Se(l, h, m)), c.has(l[h])) if (c.has(l[m])) {
      const y = d.get(a[u]), _ = y !== void 0 ? o[y] : null;
      if (_ === null) {
        const p = gt(e, o[h]);
        nt(p, n[u]), r[u] = p;
      } else r[u] = nt(_, n[u]), gt(e, o[h], _), o[y] = null;
      u++;
    } else qt(o[m]), m--;
    else qt(o[h]), h++;
    for (; u <= f; ) {
...
const At = [
  ...
  if (n === "default" && ((h = e.__themes) == null ? void 0 : h.cacheKey) === "default")
    return;
  if (n && n !== "default" && ((m = t == null ? void 0 : t.themes) != null && m[n])) {
...
function E1(e, t, i, s, o) {
  ...
  return Object.values(e).filter((p) => {
    ...
    if (!(p.area_id != null || C && C.area_id != null) || l && !((((A = p.labels) == null ? void 0 : A.some((P) => l.includes(P))) ?? !1) || (((E = C == null ? void 0 : C.labels) == null ? void 0 : E.some((P) => l.includes(P))) ?? !1)) || n && !(p.area_id !== void 0 && p.area_id !== null && n.includes(p.area_id) || C && C.area_id !== void 0 && C.area_id !== null && n.includes(C.area_id)))
      return !1;
    if (a) {
      const O = p.area_id ? _.get(p.area_id) : void 0, P = C != null && C.area_id ? _.get(C.area_id) : void 0;
      if (!(O && a.includes(O) || P && a.includes(P))) return !1;
    }
    return h.size && (p.area_id && h.has(p.area_id) || C && C.area_id && h.has(C.area_id)) || (k = p.labels) != null && k.some((O) => m.has(O)) || u.has(p.entity_id) ? !1 : !p.hidden;
  }).map((p) => p.entity_id);
}
function S1(e, t) {
  const i = {};
...
const ge = class ge extends G {
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return n.sort((r, c) => {
            ...
            if (d !== h) return d - h;
            const m = q(r.entity_id), u = q(c.entity_id), f = this.hass ? U(this.hass, r.state, m) : r.state, y = this.hass ? U(this.hass, c.state, u) : c.state, _ = (f || "").localeCompare(y || "");
            return _ !== 0 ? _ : l(r.entity_id, c.entity_id);
          });
        }
        const a = Tt(o, s);
  ...
  _getPopupCardConfig(t) {
    var y, _, p, b;
    const i = this.card, s = q(t.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (b = (p = (_ = (y = this.hass) == null ? void 0 : y.states) == null ? void 0 : _[t.entity_id]) == null ? void 0 : p.attributes) == null ? void 0 : b.device_class, a = j(o, n), l = typeof (i == null ? void 0 : i.getCustomizationForType) == "function" ? i.getCustomizationForType(a) : void 0, r = l == null ? void 0 : l.popup_card, c = r && typeof r.type == "string" && r.type || "tile", d = c === "tile" ? mo[s] ?? {} : {};
    let h = {};
    ...
    const m = {
      ...
      ...d,
      ...h
    }, u = this._configHash(m), f = this._popupCardConfigCache.get(t.entity_id);
  ...
  render() {
    ...
    o === void 0 && i && (d = !0);
    const h = this.sortEntitiesForPopup(c), m = new Set(c.map((L) => L.entity_id));
    Array.from(this._cardEls.keys()).forEach((L) => {
      m.has(L) || this._cardEls.delete(L);
    }), this._lastEntityIds = c.map((L) => L.entity_id);
    const u = this.groupAndSortEntities(
      c,
      a,
      this.sortEntitiesForPopup.bind(this)
    ), f = ((A = n == null ? void 0 : n._config) == null ? void 0 : A.ungroupAreas) === !0 || ((E = n == null ? void 0 : n._config) == null ? void 0 : E.ungroup_areas) === !0 || ((k = n == null ? void 0 : n._config) == null ? void 0 : k.area_grouping) !== void 0 && ((O = n == null ? void 0 : n._config) == null ? void 0 : O.area_grouping) === !1, y = u.length ? Math.max(...u.map(([, L]) => L.length)) : 0, _ = f ? Math.min(t, Math.max(1, c.length)) : Math.min(t, Math.max(1, y)), p = j(i, s), b = typeof (n == null ? void 0 : n.getCustomizationForType) == "function" ? n.getCustomizationForType(p) : void 0, C = (b == null ? void 0 : b.invert) === !0;
    return g`
      <ha-dialog
        .open=${this.open}
        hideActions
      ...
      if (L !== void 0 && ((R = (dt = ct._config) == null ? void 0 : dt.content) != null && R[L])) {
        const P1 = ct._config.content[L];
      ...
      ([L]) => L,
      ([L, ct]) => {
        const dt = a.get(L) ?? (L === "unassigned" ? "Unassigned" : L);
        return g`
...
const Z = (e, t) => e ? typeof e == "object" ? Object.entries(e).reduce((o, [n, a]) => {
  ...
  if (l && r !== void 0) {
    const c = l.trim(), d = c.startsWith("--") ? c : c.replace(/-([a-z])/g, (h, m) => m.toUpperCase());
    o[d] = r.trim();
  }
  return o;
}, {})) : {}, ie = (e, t, i) => t && t._parsedCss ? t._parsedCss : e ? Z(e) : {}, vo = ft`
...
const $o = (e, t, i, s) => s ? [] : Object.values(e).filter(
  ...
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    if (l && l.state !== void 0 && l.invert_state !== void 0) {
      const _ = l.invert_state === "true", p = a.state === l.state;
      if (!_ && !p || _ && p) return o;
    }
    const r = s.indexOf(n), c = r >= 0 ? r : 0, d = k1(
      ...
      a,
      i
    ), h = re(e, n, void 0, a, i) ?? a.attributes.friendly_name ?? n, m = ae(
      e,
      n,
      void 0,
      i
...
function Do(e, t, i, s, o, n, a) {
  ...
  if (s.includes(".")) {
    const h = s, m = q(h);
    if (d) {
      t.callService(m, "toggle", { entity_id: h });
      return;
    }
    if (c) {
      a.showMoreInfo(h);
...
let $ = class extends G {
  ...
  _entitiesByDomain() {
    var h, m, u, f;
    const e = this.hass.entities || [], t = this.hass.devices || [], i = this.hass.areas || [], s = ((h = this.hass) == null ? void 0 : h.states) || {}, o = ((m = this._config) == null ? void 0 : m.area) || null, n = ((u = this._config) == null ? void 0 : u.floor) || null, a = ((f = this._config) == null ? void 0 : f.label) || null, l = this.hiddenAreas, r = this.hiddenLabels, c = this.hiddenEntities, d = this._computeIncludedIdsMemo(
      e,
      t,
      i,
      o,
  ...
  _openDomainPopup(e) {
    ...
    if (typeof e == "number") {
      ...
      if (d) {
        const h = this._computeEntityMap(this.__registryEntities), m = this._computeDeviceMap(this.__registryDevices), u = this._computeAreaMap(this.__registryAreas);
        s = zo(
          this,
          d,
          h,
  ...
  renderExtraTab(e) {
    ...
    const { panel: t, icon: i, name: s, color: o, icon_css: n, background_color: a } = e, l = this.hass.states[t], r = this.getCustomizationForType(t), c = this._handleDomainAction(t), d = te({
    ...
    }, m = this._getIconStyles("extra", {
      color: o,
      background_color: a,
      square: this._config.square
    }), u = (r == null ? void 0 : r.state_content) ?? void 0, f = (r == null ? void 0 : r.badge_mode) ?? this.badge_mode, y = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, _ = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, p = {
      ...
      r
    ), C = { ...this._parsedGlobalCss, ...b }, v = (r == null ? void 0 : r._parsedIconCss) || Z((O = r == null ? void 0 : r.styles) == null ? void 0 : O.icon), A = {
  ...
  renderGroupTab(e, t) {
    ...
    const n = e.group_id || `${this.hass.localize("component.group.entity_component._.name")} ${t + 1}`, a = e.group_icon || Ni, l = ae(
      ...
      f
    ), _ = { ...this._parsedGlobalCss, ...y }, p = (f == null ? void 0 : f._parsedIconCss) || Z((A = f == null ? void 0 : f.styles) == null ? void 0 : A.icon), b = {
      ...this._parsedGlobalIconCss,
      ...p
    };
    return g`
  ...
  renderItemTab(e) {
    ...
    const y = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, _ = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, p = {
      ...
      r
    ), v = { ...this._parsedGlobalCss, ...C }, A = (r == null ? void 0 : r._parsedIconCss) || Z((P = r == null ? void 0 : r.styles) == null ? void 0 : P.icon), E = {
      ...this._parsedGlobalIconCss,
      ...A
    };
    return g`
  ...
  render() {
    ...
    return g`
      ...
      >
        <ha-tab-group without-scroll-controls class=${ht(a)}>
      ...
      (l) => {
        ...
        }, m = this._config.person_home_color, u = this._config.person_away_color, f = this._config.person_home_icon || "mdi:home", y = this._config.person_away_icon || "mdi:home-export-outline", _ = c ? u || "red" : m || "green", p = c ? y : f;
        return g`
                <ha-tab-group-tab
                  slot="nav"
                  panel=${l.entity_id}
...
function Po(e, t, i, s, o) {
  const n = (d, h, m) => Ht(e, d, h, m), a = n({ name: "area" }), l = n({ name: "floor" }), r = n({ name: "name" }), c = n({ name: "state" });
  return [
    {
      name: "person",
      // @ts-ignore
...
let K = class extends G {
  ...
  async updated(e) {
    ...
    if (!(!this.hass || !this._config) && e.has("_config")) {
      ...
      const d = this._lastFilter.area, h = this._lastFilter.floor, m = this._lastFilter.label, u = !J(m, c), f = !J(h, r);
      if (!J(d, l) || f || u) {
        ...
        const b = _.map((C) => this._normalizeContentEntry(C)).sort((C, v) => {
  ...
  _classesForArea(e, t, i, s, o, n) {
    var m;
    const a = ((m = this._config) == null ? void 0 : m.extra_entities) || [], l = y1(
      s,
      o,
      n,
      this.hass.states,
    ...
    return [...r, ...h, ...a].sort(
      (u, f) => {
        const y = d.indexOf(u), _ = d.indexOf(f);
  ...
  _groupValueChanged(e, t) {
    ...
    const { value: i } = e.detail, s = this.rulesets[t] ?? {
      ...
      const m = parseInt(d.split("_")[1], 10), u = parseInt(h.split("_")[1], 10);
      return m - u;
    }).map((d) => {
      const h = d.split("_")[1];
      return {
  ...
  _groupAllEntitiesByDomain() {
    ...
    const e = this.hass.entities || {}, t = this.hass.devices || {}, i = this.hass.areas || {}, s = {
      ...
      floor: Array.isArray((m = this._config) == null ? void 0 : m.floor) ? this._config.floor : (u = this._config) != null && u.floor ? [this._config.floor] : [],
      ...
      hiddenLabels: ((_ = this._config) == null ? void 0 : _.hidden_labels) ?? [],
  ...
  _hiddenEntitiesByDomain() {
    ...
    const i = this.hass.entities || {}, s = this.hass.devices || {}, o = (m = this.hass) != null && m.areas ? Object.values(this.hass.areas) : [], n = (u = this._config) == null ? void 0 : u.area, a = (f = this._config) == null ? void 0 : f.floor, l = (y = this._config) == null ? void 0 : y.label, r = n ? Array.isArray(n) ? n : [n] : [], c = a ? Array.isArray(a) ? a : [a] : [], d = l ? Array.isArray(l) ? l : [l] : [];
    for (const _ of t) {
      const p = q(_);
