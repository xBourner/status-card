 ...
 */
const kt = globalThis, le = kt.ShadowRoot && (kt.ShadyCSS === void 0 || kt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, de = Symbol(), ye = /* @__PURE__ */ new WeakMap();
let V1 = class {
  constructor(t, i, s) {
...
}, ve = le ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: U1, defineProperty: W1, getOwnPropertyDescriptor: q1, getOwnPropertyNames: K1, getOwnPropertySymbols: Y1, getPrototypeOf: J1 } = Object, et = globalThis, be = et.trustedTypes, X1 = be ? be.emptyScript : "", jt = et.reactiveElementPolyfillSupport, Ct = (e, t) => e, Ot = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? X1 : null;
      break;
  ...
  return i;
} }, he = (e, t) => !U1(e, t), Le = { attribute: !0, type: String, converter: Ot, reflect: !1, useDefault: !1, hasChanged: he };
...
let ut = class extends HTMLElement {
  ...
  static createProperty(t, i = Le) {
    if (i.state && (i.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((i = Object.create(i)).wrapped = !0), this.elementProperties.set(t, i), !i.noAccessor) {
      ...
      o !== void 0 && W1(this.prototype, t, o);
    }
  }
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Ct("properties"))) {
      const i = this.properties, s = [...K1(i), ...Y1(i)];
...
ut.elementStyles = [], ut.shadowRootOptions = { mode: "open" }, ut[Ct("elementProperties")] = /* @__PURE__ */ new Map(), ut[Ct("finalized")] = /* @__PURE__ */ new Map(), jt == null || jt({ ReactiveElement: ut }), (et.reactiveElementVersions ?? (et.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const yt = globalThis, Tt = yt.trustedTypes, Ae = Tt ? Tt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, $1 = "$lit$", Q = `lit$${Math.random().toFixed(9).slice(2)}$`, M1 = "?" + Q, Q1 = `<${M1}>`, ct = document, vt = () => ct.createComment(""), bt = (e) => e === null || typeof e != "object" && typeof e != "function", ue = Array.isArray, ti = (e) => ue(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ft = `[ 	
\f\r]`, _t = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, He = /-->/g, Ve = />/g, ot = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), $e = /'/g, Me = /"/g, w1 = /^(?:script|style|textarea|title)$/i, ei = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), g = ei(1), N = Symbol.for("lit-noChange"), z = Symbol.for("lit-nothing"), we = /* @__PURE__ */ new WeakMap(), at = ct.createTreeWalker(ct, 129);
function E1(e, t) {
...
const ii = (e, t) => {
  ...
  for (let c = 0; c < i; c++) {
    const r = e[c];
    let l, d, h = -1, m = 0;
    for (; m < r.length && (a.lastIndex = m, d = a.exec(r), d !== null); ) m = a.lastIndex, a === _t ? d[1] === "!--" ? a = He : d[1] !== void 0 ? a = Ve : d[2] !== void 0 ? (w1.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = ot) : d[3] !== void 0 && (a = ot) : a === ot ? d[0] === ">" ? (a = o ?? _t, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, l = d[1], a = d[3] === void 0 ? ot : d[3] === '"' ? Me : $e) : a === Me || a === $e ? a = ot : a === He || a === Ve ? a = _t : (a = ot, o = void 0);
    const u = a === ot && e[c + 1].startsWith("/>") ? " " : "";
    n += a === _t ? r + Q1 : h >= 0 ? (s.push(l), r.slice(0, h) + $1 + r.slice(h) + Q + u) : r + Q + (h === -2 ? c : u);
  }
  return [E1(e, n + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), s];
};
class Lt {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const c = t.length - 1, r = this.parts, [l, d] = ii(t, i);
    if (this.el = Lt.createElement(l, s), at.currentNode = this.el.content, i === 2 || i === 3) {
    ...
    for (; (o = at.nextNode()) !== null && r.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith($1)) {
          ...
          r.push({ type: 1, index: n, name: f[2], strings: u, ctor: f[1] === "." ? oi : f[1] === "?" ? ni : f[1] === "@" ? ai : Pt }), o.removeAttribute(h);
      ...
      } else if (o.nodeType === 8) if (o.data === M1) r.push({ type: 2, index: n });
      else {
        let h = -1;
...
let si = class {
  ...
  u(t) {
    ...
    for (; r !== void 0; ) {
      if (a === r.index) {
        let l;
        r.type === 2 ? l = new mt(n, n.nextSibling, this, t) : r.type === 1 ? l = new r.ctor(n, r.name, r.strings, this, t) : r.type === 6 && (l = new ri(n, this, t)), this._$AV.push(l), r = s[++c];
      }
...
class mt {
  ...
  _$AI(t, i = this) {
    t = pt(this, t, i), bt(t) ? t === z || t == null || t === "" ? (this._$AH !== z && this._$AR(), this._$AH = z) : t !== this._$AH && t !== N && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ti(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== z && bt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(ct.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
    const { values: i, _$litType$: s } = t, o = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = Lt.createElement(E1(s.h, s.h[0]), this.options)), s);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(i);
    else {
      const a = new si(o, this), c = a.u(this.options);
...
class Pt {
  ...
  _$AI(t, i = this, s, o) {
    ...
    if (n === void 0) t = pt(this, t, i, 0), a = !bt(t) || t !== this._$AH && t !== N, a && (this._$AH = t);
      ...
      const c = t;
      let r, l;
      for (t = n[0], r = 0; r < n.length - 1; r++) l = pt(this, c[s + r], i, r), l === N && (l = this._$AH[r]), a || (a = !bt(l) || l !== this._$AH[r]), l === z ? t = z : t !== z && (t += (l ?? "") + n[r + 1]), this._$AH[r] = l;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const ci = { I: mt }, Nt = yt.litHtmlPolyfillSupport;
Nt == null || Nt(Lt, mt), (yt.litHtmlVersions ?? (yt.litHtmlVersions = [])).push("3.3.1");
const li = (e, t, i) => {
...
var H1;
F._$litElement$ = !0, F.finalized = !0, (H1 = rt.litElementHydrateSupport) == null || H1.call(rt, { LitElement: F });
const Ut = rt.litElementPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const di = { attribute: !0, type: String, converter: Ot, reflect: !1, hasChanged: he }, hi = (e = di, t, i) => {
...
function M(e) {
  return (t, i) => typeof i == "object" ? hi(e, t, i) : ((s, o, n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pe = { ATTRIBUTE: 1, CHILD: 2 }, Rt = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Bt = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: ui } = ci, Ee = () => document.createComment(""), gt = (e, t, i) => {
  var n;
  const s = e._$AA.parentNode, o = t === void 0 ? e._$AB : t._$AA;
  if (i === void 0) {
    const a = s.insertBefore(Ee(), o), c = s.insertBefore(Ee(), o);
    i = new ui(a, c, e, e.options);
  } else {
  ...
  return i;
}, nt = (e, t, i = e) => (e._$AI(t, i), e), pi = {}, fi = (e, t = pi) => e._$AH = t, mi = (e) => e._$AH, Wt = (e) => {
...
const Se = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    ...
    else if (c[h] === a[u]) r[u] = nt(o[h], n[u]), h++, u++;
    else if (c[m] === a[f]) r[f] = nt(o[m], n[f]), m--, f--;
    else if (c[h] === a[f]) r[f] = nt(o[h], n[f]), gt(e, r[f + 1], o[h]), h++, f--;
    else if (c[m] === a[u]) r[u] = nt(o[m], n[u]), gt(e, o[h], o[m]), m--, u++;
    else if (l === void 0 && (l = Se(a, u, f), d = Se(c, h, m)), l.has(c[h])) if (l.has(c[m])) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const S1 = "important", _i = " !" + S1, S = Rt(class extends Bt {
  constructor(e) {
    var t;
  ...
  update(e, [t]) {
    ...
    for (const s in t) {
      ...
      if (o != null) {
        this.ft.add(s);
        const n = typeof o == "string" && o.endsWith(_i);
        s.includes("-") || n ? i.setProperty(s, n ? o.slice(0, -11) : o, n ? S1 : "") : i[s] = o;
      }
    }
    return N;
  }
...
}, P = (e) => e.substr(0, e.indexOf(".")), no = (e) => (t, i) => e.includes(t, i), me = "unavailable", ao = "unknown", ro = "off", co = [me, ao], lo = no(co), ho = (e) => {
...
function mo(e, t) {
  const i = P(e.entity_id), s = e == null ? void 0 : e.state;
  if (["button", "event", "input_button", "scene"].includes(i))
    return s !== me;
  if (lo(s) || s === ro && i !== "alert")
    return !1;
  switch (i) {
...
const y1 = /* @__PURE__ */ new Set([
  ...
  const o = [], n = po(i, "_"), a = s ? "active" : "inactive";
  ...
  const i = e == null ? void 0 : e.state, s = P(e.entity_id), o = e.attributes.device_class;
  ...
  const t = P(e.entity_id), i = e.state;
  if (t === "light" && i === "on") {
...
), bo = (e, t) => e < t ? -1 : e > t ? 1 : 0, x1 = (e, t, i = void 0) => Intl != null && Intl.Collator ? vo(i).compare(e, t) : bo(e.toLowerCase(), t.toLowerCase()), Dt = (e, t) => {
  if (e === t)
    return !0;
...
customElements.define("action-handler-status-card", Lo);
const Ao = () => {
...
function z1(e, t, i, s, o) {
  ...
  return Object.values(e).filter((p) => {
    ...
    if (!(p.area_id != null || C && C.area_id != null) || c && !((((A = p.labels) == null ? void 0 : A.some((Z) => c.includes(Z))) ?? !1) || (((E = C == null ? void 0 : C.labels) == null ? void 0 : E.some((Z) => c.includes(Z))) ?? !1)) || n && !(p.area_id !== void 0 && p.area_id !== null && n.includes(p.area_id) || C && C.area_id !== void 0 && C.area_id !== null && n.includes(C.area_id)))
      return !1;
    if (a) {
      const D = p.area_id ? _.get(p.area_id) : void 0, Z = C != null && C.area_id ? _.get(C.area_id) : void 0;
      if (!(D && a.includes(D) || Z && a.includes(Z))) return !1;
    }
    return h.size && (p.area_id && h.has(p.area_id) || C && C.area_id && h.has(C.area_id)) || (k = p.labels) != null && k.some((D) => m.has(D)) || u.has(p.entity_id) ? !1 : !p.hidden;
  }).map((p) => p.entity_id);
}
function k1(e, t) {
  const i = {};
...
const j = {
  alarm_control_panel: { on: bi, off: Li },
  siren: { on: Si, off: Pe },
  lock: { on: t1, off: Qe },
  light: { on: as, off: rs },
  media_player: { on: Ii, off: Pi },
  climate: { on: Bs, off: Gs },
  humidifier: { on: yi, off: vi },
  switch: {
    on: Xt,
    off: Qt,
    switch: { on: Xt, off: Qt },
  ...
  cover: {
    ...
    gate: { on: ts, off: Qi },
    blind: { on: zi, off: xi },
    curtain: { on: Fi, off: Ni },
    damper: { on: Ws, off: u1 },
    awning: { on: Ie, off: Ie },
    shutter: { on: so, off: io },
    shade: { on: ws, off: Es },
    window: { on: C1, off: g1 }
  },
  binary_sensor: {
    ...
    off: Jt,
    motion: { on: us, off: ps },
    moisture: { on: Ys, off: Xs },
    window: { on: C1, off: g1 },
    door: { on: Ue, off: Ne },
    lock: { on: t1, off: Qe },
    presence: { on: ss, off: is },
    occupancy: { on: Ss, off: xs },
    vibration: { on: qs, off: Ks },
    opening: { on: Os, off: Ds },
    ...
    running: { on: Cs, off: _s },
    plug: { on: o1, off: n1 },
    power: { on: ys, off: Jt },
    battery: { on: $i, off: Vi },
    battery_charging: { on: Mi, off: wi },
    gas: { on: Xi, off: Ji },
    carbon_monoxide: { on: s1, off: s1 },
    cold: { on: Ps, off: Zs },
    heat: { on: _1, off: eo },
    connectivity: { on: je, off: je },
    safety: { on: zs, off: ks },
    sound: { on: p1, off: f1 },
    update: { on: Oe, off: Te },
    tamper: { on: l1, off: l1 },
  ...
  valve: { on: Us, off: u1 },
  water_heater: { on: Js, off: Qs },
  remote: { on: Ls, off: As },
  update: { on: Oe, off: Te },
  air_quality: { on: De, off: De },
  camera: { on: ki, off: Di },
  calendar: { on: Ze, off: Re },
  scene: { on: fs, off: ms },
  notifications: { on: Ei, off: Pe },
  sensor: { on: Ke, off: Ke },
  script: { on: c1, off: c1 },
  tags: { on: d1, off: d1 },
  select: { on: wt, off: wt },
  automation: { on: Hs, off: Vs },
  button: { on: Ye, off: Ye },
  number: { on: Et, off: Et },
  conversation: { on: Ge, off: Ge },
  assist_satellite: {
    on: r1,
    off: r1
  },
  ...
  tts: { on: p1, off: f1 },
  wake_word: { on: ds, off: hs },
  weather: { on: to, off: m1 },
  zone: { on: e1, off: i1 },
...
function Oo(e, t) {
  ...
  for (const [i, s] of Object.entries(xo))
    if (s.includes(t))
      return e.localize(
...
function Ht(e, t, i, s) {
  ...
  if (t.name === "header")
    return Do(e, i, s);
  const o = ko[t.name];
  return o ? o(e) : Oo(e, t.name);
}
var To = Object.defineProperty, O = (e, t, i, s) => {
...
const ge = class ge extends F {
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return n.sort((r, l) => {
            ...
            if (d !== h) return d - h;
            const m = P(r.entity_id), u = P(l.entity_id), f = this.hass ? U(this.hass, r.state, m) : r.state, y = this.hass ? U(this.hass, l.state, u) : l.state, _ = (f || "").localeCompare(y || "");
  ...
  _getPopupCardConfig(t) {
    var y, _, p, b;
    const i = this.card, s = P(t.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (b = (p = (_ = (y = this.hass) == null ? void 0 : y.states) == null ? void 0 : _[t.entity_id]) == null ? void 0 : p.attributes) == null ? void 0 : b.device_class, a = B(o, n), c = typeof (i == null ? void 0 : i.getCustomizationForType) == "function" ? i.getCustomizationForType(a) : void 0, r = c == null ? void 0 : c.popup_card, l = r && typeof r.type == "string" && r.type || "tile", d = l === "tile" ? zo[s] ?? {} : {};
    let h = {};
  ...
  _isEntityActive(t) {
    var r;
    const i = this.selectedDomain || P(t.entity_id), s = this.selectedDeviceClass || t.attributes.device_class, o = B(i, s), n = typeof ((r = this.card) == null ? void 0 : r.getCustomizationForType) == "function" ? this.card.getCustomizationForType(o) : void 0, a = (n == null ? void 0 : n.invert) === !0;
    if (i === "climate") {
  ...
  render() {
    ...
    const t = this.card.list_mode ? 1 : this.card._config.columns || 4, i = this.selectedDomain, s = this.selectedDeviceClass, o = this.selectedGroup, n = this.card, a = /* @__PURE__ */ new Map(), c = ((v = this.hass) == null ? void 0 : v.areas) ?? [], r = Array.isArray(c) ? c : Object.values(c);
    for (const L of r)
      L && L.area_id && L.name && a.set(L.area_id, L.name);
    let l = this._entities, d = !1;
    o === void 0 && i && (d = !0);
    const h = this.sortEntitiesForPopup(l), m = new Set(l.map((L) => L.entity_id));
    ...
    ), f = ((A = n == null ? void 0 : n._config) == null ? void 0 : A.ungroupAreas) === !0 || ((E = n == null ? void 0 : n._config) == null ? void 0 : E.ungroup_areas) === !0 || ((k = n == null ? void 0 : n._config) == null ? void 0 : k.area_grouping) !== void 0 && ((D = n == null ? void 0 : n._config) == null ? void 0 : D.area_grouping) === !1, y = u.length ? Math.max(...u.map(([, L]) => L.length)) : 0, _ = f ? Math.min(t, Math.max(1, l.length)) : Math.min(t, Math.max(1, y)), p = B(i, s), b = typeof (n == null ? void 0 : n.getCustomizationForType) == "function" ? n.getCustomizationForType(p) : void 0, C = (b == null ? void 0 : b.invert) === !0;
    return g`
      <ha-dialog
        .open=${this.open}
        hideActions
      ...
      if (L !== void 0 && ((G = (dt = lt._config) == null ? void 0 : dt.content) != null && G[L])) {
        const B1 = lt._config.content[L];
      ...
      "ui.panel.lovelace.editor.card.entities.name"
        ...
        <div class="dialog-content scrollable">
          ${(Z = this.card) != null && Z.list_mode ? f ? g`
...
const R = (e, t) => e ? typeof e == "object" ? Object.entries(e).reduce((o, [n, a]) => {
  ...
  if (c && r !== void 0) {
    const l = c.trim(), d = l.startsWith("--") ? l : l.replace(/-([a-z])/g, (h, m) => m.toUpperCase());
    o[d] = r.trim();
  }
  return o;
}, {})) : {}, ie = (e, t, i) => t && t._parsedCss ? t._parsedCss : e ? R(e) : {}, Io = ft`
...
function se(e, t, i, s, o, n, a, c) {
  const r = B(i, s), l = Vt(t, r, c), d = (l == null ? void 0 : l.invert) === !0;
  switch (i) {
    case "device_tracker":
      return Zo(e, d);
    case "lock":
...
const jo = (e, t, i, s) => s ? [] : Object.values(e).filter(
...
).map((o) => o.entity_id).reverse(), Fo = (e, t) => e.map((i) => t[i]).filter((i) => !!i), No = (e, t, i) => {
  const s = e.content || [];
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    const r = s.indexOf(n), l = r >= 0 ? r : 0, d = T1(
      e,
      n,
      void 0,
      a,
      i
    ), h = ae(e, n, void 0, a, i) ?? a.attributes.friendly_name ?? n, m = $t(
      e,
      "icon_color",
      n,
      void 0,
      i
    ) || ((c == null ? void 0 : c.activate_state_color) ?? e.activate_state_color ? yo(a) : void 0) || e.color, u = Po(
      e,
      n,
      void 0,
      i
  ...
  if (Array.isArray(e.filters))
    r = e.filters.filter((l) => re.includes(l.key));
  else {
    const l = e;
    re.forEach((d) => {
  ...
  if (Array.isArray(t.filters))
    c = t.filters.filter((r) => !re.includes(r.key));
  else {
    const r = t;
    [
      "state",
...
function Ko(e, t, i, s, o) {
  var m;
  const n = e.__registryEntities || [], a = e.__registryDevices || [], c = e.__registryAreas || [], r = i || new Map(n.map((u) => [u.entity_id, u])), l = s || new Map(a.map((u) => [u.id, u])), d = o || new Map(c.map((u) => [u.area_id, u])), h = P1(
    t,
    n,
    a,
    c,
...
const Yo = {
  ...
  floor: (e, t, { entityMap: i, deviceMap: s, areaMap: o }, n) => {
    ...
    return x(c == null ? void 0 : c.floor_id, t);
  },
...
function R1(e, t, i, s) {
  var a, c;
  const o = ((a = s.entityMap) == null ? void 0 : a.get(t.entity_id)) || ((c = s.entities) == null ? void 0 : c.find((r) => r.entity_id === t.entity_id)), n = Yo[i.key];
...
var Qo = Object.defineProperty, tn = Object.getOwnPropertyDescriptor, w = (e, t, i, s) => {
  for (var o = s > 1 ? void 0 : s ? tn(t, i) : t, n = e.length - 1, a; n >= 0; n--)
...
let $ = class extends F {
  constructor() {
    ...
    ), this._customizationIndexMemo = V(O1), this._computePersonIdsMemo = V(jo), this._mapPersonIdsToStatesMemo = V(
      (e, t) => Fo(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
    ...
    ), this._computeGroupItemsMemo = V(Uo), this._computeDomainItemsMemo = V(Wo), this._computeDeviceClassItemsMemo = V(qo), this._computeEntityMap = V(
  ...
  _entitiesByDomain() {
    var h, m, u, f;
    const e = this.hass.entities || [], t = this.hass.devices || [], i = this.hass.areas || [], s = ((h = this.hass) == null ? void 0 : h.states) || {}, o = ((m = this._config) == null ? void 0 : m.area) || null, n = ((u = this._config) == null ? void 0 : u.floor) || null, a = ((f = this._config) == null ? void 0 : f.label) || null, c = this.hiddenAreas, r = this.hiddenLabels, l = this.hiddenEntities, d = this._computeIncludedIdsMemo(
      e,
      t,
      i,
      o,
  ...
  setConfig(e) {
    ...
    this._config = e, this.hide_person = e.hide_person !== void 0 ? e.hide_person : !1, this.hide_content_name = e.hide_content_name !== void 0 ? e.hide_content_name : !1, this.list_mode = e.list_mode !== void 0 ? e.list_mode : !1, this.badge_mode = !!e.badge_mode, this.no_background = !!e.no_background, this.badge_color = e.badge_color || "", this.badge_text_color = e.badge_text_color || "", this.hiddenEntities = e.hidden_entities || [], this.hiddenLabels = e.hidden_labels || [], this.hiddenAreas = e.hidden_areas || [], this._config.customization, this._config.styles && (this._config.styles.card && (this._parsedGlobalCardCss = R(this._config.styles.card)), this._config.styles.button && (this._parsedGlobalCss = R(this._config.styles.button)), this._config.styles.icon && (this._parsedGlobalIconCss = R(this._config.styles.icon)), this._config.styles.name && (this._parsedGlobalNameCss = R(this._config.styles.name)), this._config.styles.state && (this._parsedGlobalStateCss = R(this._config.styles.state)));
  }
  _showPopup(e, t, i) {
    e.dispatchEvent(
      new CustomEvent("show-dialog", {
  ...
  updated(e) {
    ...
    (e.has("hass") && (!t || t.themes !== this.hass.themes) || e.has("_config") && (!i || i.theme !== this._config.theme)) && oo(
      this,
      this.hass.themes,
      this._config.theme
    );
  ...
  renderExtraTab(e) {
    var E, k, D;
    const { panel: t, icon: i, name: s, color: o, icon_css: n, background_color: a } = e, c = this.hass.states[t], r = this.getCustomizationForType(t), l = this._handleDomainAction(t), d = te({
      hasHold: xt(
    ...
    }), u = (r == null ? void 0 : r.state_content) ?? "state", f = (r == null ? void 0 : r.badge_mode) ?? this.badge_mode, y = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, _ = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, p = {
      ...
      r
    ), C = { ...this._parsedGlobalCss, ...b }, v = (r == null ? void 0 : r._parsedIconCss) || R((D = r == null ? void 0 : r.styles) == null ? void 0 : D.icon), A = {
  ...
  renderGroupTab(e, t) {
    ...
    const n = e.group_id || `${this.hass.localize("component.group.entity_component._.name")} ${t + 1}`, a = e.group_icon || Ki, c = A1(
      this._config,
      n,
      void 0,
      this._customizationIndexMemo(this._config.customization)
      ...
      f
    ), _ = { ...this._parsedGlobalCss, ...y }, p = (f == null ? void 0 : f._parsedIconCss) || R((A = f == null ? void 0 : f.styles) == null ? void 0 : A.icon), b = {
      ...this._parsedGlobalIconCss,
      ...p
    };
    return g`
  ...
  renderItemTab(e) {
    ...
    const c = A1(
      ...
      B(t, i)
    ), l = this._handleDomainAction(t, i), d = te({
      hasHold: xt(
        (r == null ? void 0 : r.hold_action) ?? this._config.hold_action
      ),
      hasDoubleClick: xt(
    ...
    const y = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, _ = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, p = {
      ...
      ((k = r == null ? void 0 : r.styles) == null ? void 0 : k.button) || ((D = r == null ? void 0 : r.styles) == null ? void 0 : D.card),
      r
    ), v = { ...this._parsedGlobalCss, ...C }, A = (r == null ? void 0 : r._parsedIconCss) || R((Z = r == null ? void 0 : r.styles) == null ? void 0 : Z.icon), E = {
      ...this._parsedGlobalIconCss,
      ...A
    };
    return g`
  ...
  render() {
    ...
    return g`
      ...
      (c) => {
        ...
        }, m = this._config.person_home_color, u = this._config.person_away_color, f = this._config.person_home_icon || "mdi:home", y = this._config.person_away_icon || "mdi:home-export-outline", _ = l ? u || "red" : m || "green", p = l ? y : f;
        return g`
                <ha-tab-group-tab
                  slot="nav"
                  panel=${c.entity_id}
...
function en(e, t, i, s, o) {
  const n = (d, h, m) => Ht(e, d, h, m), a = n({ name: "area" }), c = n({ name: "floor" }), r = n({ name: "name" }), l = n({ name: "state" });
  return [
    {
      name: "person",
      // @ts-ignore
...
var ln = Object.defineProperty, dn = Object.getOwnPropertyDescriptor, Y = (e, t, i, s) => {
  for (var o = s > 1 ? void 0 : s ? dn(t, i) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (s ? a(t, i, o) : a(o)) || o);
...
let W = class extends F {
  ...
  render() {
    ...
    if (!this.hass || !this.config)
      return g``;
    let e;
    this._activeTab === "appearance" ? e = nn(
      this.getSchema,
...
var hn = Object.defineProperty, un = Object.getOwnPropertyDescriptor, Gt = (e, t, i, s) => {
...
var pn = Object.defineProperty, fn = Object.getOwnPropertyDescriptor, st = (e, t, i, s) => {
  for (var o = s > 1 ? void 0 : s ? fn(t, i) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (s ? a(t, i, o) : a(o)) || o);
  return s && o && pn(t, i, o), o;
};
let K = class extends F {
  ...
  async updated(e) {
    ...
    if (!(!this.hass || !this._config) && e.has("_config")) {
      ...
      const d = this._lastFilter.area, h = this._lastFilter.floor, m = this._lastFilter.label, u = !J(m, l), f = !J(h, r);
      if (!J(d, c) || f || u) {
  ...
  _normalizeContentEntry(e) {
    ...
    if (t) {
      ...
      return j[s] || X.includes(s) ? `${s} - ${o}` : e;
    }
    const i = e.trim().toLowerCase().replace(/\s+/g, "_");
    return j[i] || X.includes(i) ? i : e;
  }
  _labelForTypePair(e) {
    var i, s, o;
    if (e.includes(".")) {
  ...
  _classesForArea(e, t, i, s, o, n) {
    var m;
    const a = ((m = this._config) == null ? void 0 : m.extra_entities) || [], c = b1(
      s,
      o,
      n,
      this.hass.states,
  ...
  _groupAllEntitiesByDomain() {
    ...
    return r.sort((v, A) => v.localeCompare(A)).map((v) => {
      ...
      return { domain: v, entities: Array.from(A).sort(l) };
    });
  }
  _domainLabel(e) {
    var t, i;
  ...
  _hiddenEntitiesByDomain() {
    ...
    const i = this.hass.entities || {}, s = this.hass.devices || {}, o = (m = this.hass) != null && m.areas ? Object.values(this.hass.areas) : [], n = (u = this._config) == null ? void 0 : u.area, a = (f = this._config) == null ? void 0 : f.floor, c = (y = this._config) == null ? void 0 : y.label, r = n ? Array.isArray(n) ? n : [n] : [], l = a ? Array.isArray(a) ? a : [a] : [], d = c ? Array.isArray(c) ? c : [c] : [];
    for (const _ of t) {
      const p = P(_);
      ...
      if (((b == null ? void 0 : b.area_id) != null || (C == null ? void 0 : C.area_id) != null) && !(d.length && !(Array.isArray(b == null ? void 0 : b.labels) && b.labels.some((E) => d.includes(E)) || Array.isArray(C == null ? void 0 : C.labels) && C.labels.some((E) => d.includes(E)))) && !(r.length && !(b != null && b.area_id && r.includes(b.area_id) || C != null && C.area_id && r.includes(C.area_id)))) {
        if (l.length) {
          const A = (b == null ? void 0 : b.area_id) && o.some(
            (k) => k.area_id === b.area_id && k.floor_id && l.includes(k.floor_id)
          ), E = (C == null ? void 0 : C.area_id) && o.some(
            (k) => k.area_id === C.area_id && k.floor_id && l.includes(k.floor_id)
          );
          if (!A && !E) continue;
        }
        e[p] || (e[p] = []), e[p].push(_);
