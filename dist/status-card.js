...
\f\r"'\`<>=]|("|')|))|$)`, "g"), He = /'/g, Ve = /"/g, A1 = /^(?:script|style|textarea|title)$/i, J1 = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), g = J1(1), B = Symbol.for("lit-noChange"), S = Symbol.for("lit-nothing"), $e = /* @__PURE__ */ new WeakMap(), nt = rt.createTreeWalker(rt, 129);
function H1(e, t) {
...
class ft {
  ...
  _$AI(t, i = this) {
    t = ut(this, t, i), yt(t) ? t === S || t == null || t === "" ? (this._$AH !== S && this._$AR(), this._$AH = S) : t !== this._$AH && t !== B && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : K1(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== S && yt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(rt.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
...
class Tt {
  ...
  _$AI(t, i = this, s, o) {
    ...
    if (n === void 0) t = ut(this, t, i, 0), a = !yt(t) || t !== this._$AH && t !== B, a && (this._$AH = t);
      ...
      const c = t;
      let r, l;
      for (t = n[0], r = 0; r < n.length - 1; r++) l = ut(this, c[s + r], i, r), l === B && (l = this._$AH[r]), a || (a = !yt(l) || l !== this._$AH[r]), l === S ? t = S : t !== S && (t += (l ?? "") + n[r + 1]), this._$AH[r] = l;
    }
    a && !o && this.j(t);
  }
  j(t) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const V1 = "important", hi = " !" + V1, I = Zt(class extends Pt {
  constructor(e) {
    var t;
...
function M1(e, t, i, s, o) {
  ...
  return Object.values(e).filter((p) => {
    ...
    if (!(p.area_id != null || C && C.area_id != null) || c && !((((A = p.labels) == null ? void 0 : A.some((N) => c.includes(N))) ?? !1) || (((x = C == null ? void 0 : C.labels) == null ? void 0 : x.some((N) => c.includes(N))) ?? !1)) || n && !(p.area_id !== void 0 && p.area_id !== null && n.includes(p.area_id) || C && C.area_id !== void 0 && C.area_id !== null && n.includes(C.area_id)))
      return !1;
    if (a) {
...
const me = class me extends R {
  ...
  render() {
    ...
    ), _ = ((A = n == null ? void 0 : n._config) == null ? void 0 : A.ungroupAreas) === !0 || ((x = n == null ? void 0 : n._config) == null ? void 0 : x.ungroup_areas) === !0 || ((O = n == null ? void 0 : n._config) == null ? void 0 : O.area_grouping) !== void 0 && ((Z = n == null ? void 0 : n._config) == null ? void 0 : Z.area_grouping) === !1, v = u.length ? Math.max(...u.map(([, L]) => L.length)) : 0, m = _ ? Math.min(t, Math.max(1, l.length)) : Math.min(t, Math.max(1, v)), p = T(i, s), y = typeof (n == null ? void 0 : n.getCustomizationForType) == "function" ? n.getCustomizationForType(p) : void 0, C = (y == null ? void 0 : y.invert) === !0;
    return g`
      <ha-dialog
        .open=${this.open}
        hideActions
...
function Ht(e, t, i) {
  return t ? (i || S1(e.customization)).get(t.toLowerCase()) : void 0;
}
...
const Ao = (e, t, i, s) => s ? [] : Object.values(e).filter(
  ...
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    const r = s.indexOf(n), l = r >= 0 ? r : 0, d = x1(
      e,
      n,
      void 0,
      a,
...
function D1(e, t, i, s) {
  var a, c;
  const o = ((a = s.entityMap) == null ? void 0 : a.get(t.entity_id)) || ((c = s.entities) == null ? void 0 : c.find((r) => r.entity_id === t.entity_id)), n = So[i.key];
...
function zo(e, t, i, s, o, n, a) {
  n.stopPropagation();
  const c = n.detail.action, r = St(i, c, s, o), l = typeof r == "string" && r === "more-info" || typeof r == "object" && (r == null ? void 0 : r.action) === "more-info", d = typeof r == "string" && r === "toggle" || typeof r == "object" && (r == null ? void 0 : r.action) === "toggle";
  if (s.includes(".")) {
    const h = s, f = G(h);
    if (d) {
...
let M = class extends R {
  constructor() {
    ...
    ), this._customizationIndexMemo = H(S1), this._computePersonIdsMemo = H(Ao), this._mapPersonIdsToStatesMemo = H(
      (e, t) => Ho(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
...
let W = class extends R {
    ...
    if (!(!this.hass || !this._config) && e.has("_config")) {
      ...
      if (!J(d, c) || _ || u) {
        ...
        const y = m.map((C) => this._normalizeContentEntry(C)).sort((C, b) => {
          const A = p.indexOf(C), x = p.indexOf(b);
  ...
  _hiddenEntitiesByDomain() {
    ...
    for (const m of t) {
      ...
      if (((y == null ? void 0 : y.area_id) != null || (C == null ? void 0 : C.area_id) != null) && !(d.length && !(Array.isArray(y == null ? void 0 : y.labels) && y.labels.some((x) => d.includes(x)) || Array.isArray(C == null ? void 0 : C.labels) && C.labels.some((x) => d.includes(x)))) && !(r.length && !(y != null && y.area_id && r.includes(y.area_id) || C != null && C.area_id && r.includes(C.area_id)))) {
        if (l.length) {
          const A = (y == null ? void 0 : y.area_id) && o.some(
            (O) => O.area_id === y.area_id && O.floor_id && l.includes(O.floor_id)
          ), x = (C == null ? void 0 : C.area_id) && o.some(
