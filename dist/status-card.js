...
let ft = class extends HTMLElement {
  ...
  _$AK(t, i) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const l = s.getPropertyOptions(o), r = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((n = l.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? l.converter : It;
      this._$Em = o;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const bt = globalThis, Tt = bt.trustedTypes, $e = Tt ? Tt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, x1 = "$lit$", Q = `lit$${Math.random().toFixed(9).slice(2)}$`, z1 = "?" + Q, oi = `<${z1}>`, ct = document, Lt = () => ct.createComment(""), At = (e) => e === null || typeof e != "object" && typeof e != "function", pe = Array.isArray, ni = (e) => pe(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Nt = `[ 	
\f\r]`, Ct = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Me = /-->/g, we = />/g, nt = RegExp(`>|${Nt}(?:([^\\s"'>=/]+)(${Nt}*=${Nt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ee = /'/g, Se = /"/g, k1 = /^(?:script|style|textarea|title)$/i, ai = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), g = ai(1), U = Symbol.for("lit-noChange"), D = Symbol.for("lit-nothing"), xe = /* @__PURE__ */ new WeakMap(), rt = ct.createTreeWalker(ct, 129);
function D1(e, t) {
...
const ri = (e, t) => {
  ...
  for (let l = 0; l < i; l++) {
    const r = e[l];
    let c, d, h = -1, p = 0;
    for (; p < r.length && (a.lastIndex = p, d = a.exec(r), d !== null); ) p = a.lastIndex, a === Ct ? d[1] === "!--" ? a = Me : d[1] !== void 0 ? a = we : d[2] !== void 0 ? (k1.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = nt) : d[3] !== void 0 && (a = nt) : a === nt ? d[0] === ">" ? (a = o ?? Ct, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, c = d[1], a = d[3] === void 0 ? nt : d[3] === '"' ? Se : Ee) : a === Se || a === Ee ? a = nt : a === Me || a === we ? a = Ct : (a = nt, o = void 0);
    const u = a === nt && e[l + 1].startsWith("/>") ? " " : "";
    n += a === Ct ? r + oi : h >= 0 ? (s.push(c), r.slice(0, h) + x1 + r.slice(h) + Q + u) : r + Q + (h === -2 ? l : u);
  }
...
class Ht {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const l = t.length - 1, r = this.parts, [c, d] = ri(t, i);
    if (this.el = Ht.createElement(c, s), rt.currentNode = this.el.content, i === 2 || i === 3) {
    ...
    for (; (o = rt.nextNode()) !== null && r.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(x1)) {
          ...
          r.push({ type: 1, index: n, name: _[2], strings: u, ctor: _[1] === "." ? ci : _[1] === "?" ? di : _[1] === "@" ? hi : Zt }), o.removeAttribute(h);
...
let li = class {
  ...
  u(t) {
    ...
    for (; r !== void 0; ) {
      if (a === r.index) {
        let c;
        r.type === 2 ? c = new gt(n, n.nextSibling, this, t) : r.type === 1 ? c = new r.ctor(n, r.name, r.strings, this, t) : r.type === 6 && (c = new ui(n, this, t)), this._$AV.push(c), r = s[++l];
      }
...
class gt {
  ...
  _(t) {
    this._$AH !== D && At(this._$AH) ? this._$AA.nextSibling.data = t : this.T(ct.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
    ...
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(i);
      ...
      const a = new li(o, this), l = a.u(this.options);
...
class Zt {
  ...
  _$AI(t, i = this, s, o) {
    ...
    if (n === void 0) t = _t(this, t, i, 0), a = !At(t) || t !== this._$AH && t !== U, a && (this._$AH = t);
      ...
      const l = t;
      let r, c;
      for (t = n[0], r = 0; r < n.length - 1; r++) c = _t(this, l[s + r], i, r), c === U && (c = this._$AH[r]), a || (a = !At(c) || c !== this._$AH[r]), c === D ? t = D : t !== D && (t += (c ?? "") + n[r + 1]), this._$AH[r] = c;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
var E1;
N._$litElement$ = !0, N.finalized = !0, (E1 = lt.litElementHydrateSupport) == null || E1.call(lt, { LitElement: N });
const Wt = lt.litElementPolyfillSupport;
...
const { I: gi } = pi, ze = () => document.createComment(""), yt = (e, t, i) => {
  ...
  if (i === void 0) {
    const a = s.insertBefore(ze(), o), l = s.insertBefore(ze(), o);
    i = new gi(a, l, e, e.options);
  } else {
...
const ke = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    ...
    else if (l[h] === a[u]) r[u] = at(o[h], n[u]), h++, u++;
    else if (l[p] === a[_]) r[_] = at(o[p], n[_]), p--, _--;
    else if (l[h] === a[_]) r[_] = at(o[h], n[_]), yt(e, r[_ + 1], o[h]), h++, _--;
    else if (l[p] === a[u]) r[u] = at(o[p], n[u]), yt(e, o[h], o[p]), p--, u++;
    else if (c === void 0 && (c = ke(a, u, _), d = ke(l, h, p)), c.has(l[h])) if (c.has(l[p])) {
      const v = d.get(a[u]), C = v !== void 0 ? o[v] : null;
      if (C === null) {
        const f = yt(e, o[h]);
        at(f, n[u]), r[u] = f;
      } else r[u] = at(C, n[u]), yt(e, o[h], C), o[v] = null;
      u++;
    } else qt(o[p]), p--;
    else qt(o[h]), h++;
    for (; u <= _; ) {
...
const Vt = [
  ...
  if (n && n !== "default" && ((p = t == null ? void 0 : t.themes) != null && p[n])) {
    const { modes: C, ...f } = t.themes[n] || {};
    r = { ...r, ...f }, C && (a && C.dark ? r = { ...r, ...C.dark } : !a && C.light && (r = { ...r, ...C.light }));
  ...
  if (((v = e.__themes) == null ? void 0 : v.cacheKey) === l) {
    let C = !0;
    if (c.size !== d.size)
      C = !1;
    else
  ...
  for (const [C, f] of Object.entries(r))
    e.style.setProperty(`--${C}`, String(f));
...
function T1(e, t, i, s, o) {
  ...
  return Object.values(e).filter((f) => {
    var y, L, $;
    const m = f.entity_id.split(".")[0];
    if (!_.has(m)) return !1;
    if (m === "update")
      return !f.hidden;
    const b = f.device_id ? v.get(f.device_id) : void 0;
    if (!(f.area_id != null || b && b.area_id != null) || l && !((((y = f.labels) == null ? void 0 : y.some((Z) => l.includes(Z))) ?? !1) || (((L = b == null ? void 0 : b.labels) == null ? void 0 : L.some((Z) => l.includes(Z))) ?? !1)) || n && !(f.area_id !== void 0 && f.area_id !== null && n.includes(f.area_id) || b && b.area_id !== void 0 && b.area_id !== null && n.includes(b.area_id)))
      return !1;
    if (a) {
      const x = f.area_id ? C.get(f.area_id) : void 0, Z = b != null && b.area_id ? C.get(b.area_id) : void 0;
      if (!(x && a.includes(x) || Z && a.includes(Z))) return !1;
    }
    return h.size && (f.area_id && h.has(f.area_id) || b && b.area_id && h.has(b.area_id)) || ($ = f.labels) != null && $.some((x) => p.has(x)) || u.has(f.entity_id) ? !1 : !f.hidden;
  }).map((f) => f.entity_id);
}
function P1(e, t) {
  const i = {};
...
const Ce = class Ce extends N {
  constructor() {
    super(...arguments), this.open = !1, this.title = "", this.content = "", this.entities = [], this._showAll = !1, this._cardEls = /* @__PURE__ */ new Map(), this._lastEntityIds = [], this._activeEntities = [], this._allEntities = [], this._onClosed = (t) => {
      var i;
      t && t.type !== "click" && t.target !== ((i = this.shadowRoot) == null ? void 0 : i.querySelector("wa-dialog")) || this._closeDialog();
    }, this._closeDialog = () => {
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return n.sort((r, c) => {
            ...
            if (d !== h) return d - h;
            const p = I(r.entity_id), u = I(c.entity_id), _ = this.hass ? W(this.hass, r.state, p) : r.state, v = this.hass ? W(this.hass, c.state, u) : c.state, C = (_ || "").localeCompare(v || "");
            return C !== 0 ? C : l(r.entity_id, c.entity_id);
          });
        }
        const a = Pt(o, s);
        return n.sort((l, r) => a(l.entity_id, r.entity_id));
      }
    ), this.groupAndSortEntities = w(
      (t, i, s) => {
  ...
  _applyDialogStyle() {
    var s, o, n, a;
    const t = (o = (s = document.querySelector("body > home-assistant")) == null ? void 0 : s.shadowRoot) == null ? void 0 : o.querySelector("status-card-popup");
    if (!t) return !1;
    const i = (n = t.shadowRoot) == null ? void 0 : n.querySelector("wa-dialog");
    if (i) {
      const l = (a = i.shadowRoot) == null ? void 0 : a.querySelector("[part='panel'], [part='dialog']");
      if (l)
        return l.style.minHeight = "unset", !0;
    }
    return !1;
  }
  firstUpdated(t) {
  ...
  _getPopupCardConfig(t) {
    ...
    if (this.selectedGroup !== void 0 && ((v = i._config.content) != null && v[this.selectedGroup])) {
      const V = i._config.content[this.selectedGroup], y = i.getCustomizationForType(V);
    ...
    const s = I(t.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (b = (m = (f = (C = this.hass) == null ? void 0 : C.states) == null ? void 0 : f[t.entity_id]) == null ? void 0 : m.attributes) == null ? void 0 : b.device_class, a = R(o, n), l = typeof (i == null ? void 0 : i.getCustomizationForType) == "function" ? i.getCustomizationForType(a) : void 0, r = l == null ? void 0 : l.popup_card, c = r && typeof r.type == "string" && r.type || "tile", d = c === "tile" ? To[s] ?? {} : {};
    let h = {};
    if (r && typeof r == "object") {
      const { type: V, entity: y, ...L } = r;
      h = L;
    } else
      h = {};
    const p = {
  ...
  sortEntitiesForPopup(t) {
    ...
    return this._sortEntitiesMemo(
      ...
      ((l = this.hass) == null ? void 0 : l.states) ?? {}
    );
  }
  render() {
    var $, x, Z, ot, ve, be;
    if (!this.open) return g``;
    const t = this._getGroupCustomization(), i = (t == null ? void 0 : t.list_mode) ?? this.card.list_mode, s = (t == null ? void 0 : t.columns) ?? this.card._config.columns ?? 4, o = i ? 1 : s, n = this.selectedDomain, a = this.selectedDeviceClass, l = this.selectedGroup, r = this.card, c = /* @__PURE__ */ new Map(), d = (($ = this.hass) == null ? void 0 : $.areas) ?? [], h = Array.isArray(d) ? d : Object.values(d);
    for (const A of h)
      A && A.area_id && A.name && c.set(A.area_id, A.name);
    let p = this._entities, u = !1;
    l === void 0 && n && (u = !0);
    const _ = this.sortEntitiesForPopup(p), v = new Set(p.map((A) => A.entity_id));
    Array.from(this._cardEls.keys()).forEach((A) => {
      v.has(A) || this._cardEls.delete(A);
    }), this._lastEntityIds = p.map((A) => A.entity_id);
    const C = this.groupAndSortEntities(
      p,
      c,
      this.sortEntitiesForPopup.bind(this)
    ), f = (t == null ? void 0 : t.ungroup_areas) === !0 || ((x = r == null ? void 0 : r._config) == null ? void 0 : x.ungroupAreas) === !0 || ((Z = r == null ? void 0 : r._config) == null ? void 0 : Z.ungroup_areas) === !0 || ((ot = r == null ? void 0 : r._config) == null ? void 0 : ot.area_grouping) !== void 0 && ((ve = r == null ? void 0 : r._config) == null ? void 0 : ve.area_grouping) === !1, m = C.length ? Math.max(...C.map(([, A]) => A.length)) : 0, b = f ? Math.min(o, Math.max(1, p.length)) : Math.min(o, Math.max(1, m)), V = R(n, a), y = typeof (r == null ? void 0 : r.getCustomizationForType) == "function" ? r.getCustomizationForType(V) : void 0, L = (y == null ? void 0 : y.invert) === !0;
    return g`
      <wa-dialog
        .open=${this.open}
        ...
        this.selectedDomain || void 0
          ...
          ${u ? g`
                <ha-dropdown
                  ...
                  @wa-after-hide=${(A) => A.stopPropagation()}
                >
                  <ha-icon-button
                    slot="trigger"
      ...
      ([A]) => A,
      ([A, dt]) => {
        const ht = c.get(A) ?? (A === "unassigned" ? "Unassigned" : A);
        return g`
...
const ye = class ye extends N {
  ...
  render() {
    ...
    const t = this.selectedDomain || "", i = this.selectedDeviceClass, s = R(t, i), o = (l = (a = this.card) == null ? void 0 : a.getCustomizationForType) == null ? void 0 : l.call(a, s), n = (o == null ? void 0 : o.invert) === !0;
    return g`
      <wa-dialog
        .open=${this.open}
        label="${n ? this.hass.localize("ui.card.common.turn_on") + "?" : this.hass.localize("ui.card.common.turn_off") + "?"}"
...
function oe(e, t, i, s, o, n, a, l) {
  const r = R(i, s), c = Mt(t, r, l), d = (c == null ? void 0 : c.invert) === !0;
  switch (i) {
    case "device_tracker":
      return Fo(e, d);
    case "lock":
...
const qo = (e, t, i, s) => s ? [] : Object.values(e).filter(
  ...
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    const a = t[n];
    if (!a) return o;
    const l = (v = e.customization) == null ? void 0 : v.find(
      (C) => C.type === n
    );
    if (l && l.state !== void 0 && l.invert_state !== void 0) {
      const C = l.invert_state === "true", f = a.state === l.state;
      if (!C && !f || C && f) return o;
    }
    const r = s.indexOf(n), c = r >= 0 ? r : 0, d = R1(
      e,
      n,
      void 0,
      a,
      i
    ), h = re(e, n, void 0, a, i) ?? a.attributes.friendly_name ?? n, p = wt(
      e,
      "icon_color",
      n,
      void 0,
      i
    ) || ((l == null ? void 0 : l.activate_state_color) ?? e.activate_state_color ? Ho(a) : void 0) || e.color, u = jo(
      e,
      n,
      void 0,
      i
...
function tn(e, t, i, s, o) {
  var p;
  const n = e.__registryEntities || [], a = e.__registryDevices || [], l = e.__registryAreas || [], r = i || new Map(n.map((u) => [u.entity_id, u])), c = s || new Map(a.map((u) => [u.id, u])), d = o || new Map(l.map((u) => [u.area_id, u])), h = j1(
    t,
    n,
    a,
    l,
...
function w1(e, t, i, s, o, n, a) {
  n.stopPropagation();
  const l = n.detail.action, r = kt(i, l, s, o), c = typeof r == "string" && r === "more-info" || typeof r == "object" && (r == null ? void 0 : r.action) === "more-info", d = typeof r == "string" && r === "toggle" || typeof r == "object" && (r == null ? void 0 : r.action) === "toggle";
  if (s.includes(".")) {
    const h = s, p = I(h);
    if (d) {
...
var sn = Object.defineProperty, on = Object.getOwnPropertyDescriptor, S = (e, t, i, s) => {
...
let E = class extends N {
  constructor() {
    ...
    ), this._customizationIndexMemo = w(G1), this._computePersonIdsMemo = w(qo), this._mapPersonIdsToStatesMemo = w(
      (e, t) => Ko(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
    ...
    ), this._computeGroupItemsMemo = w(Jo), this._computeDomainItemsMemo = w(Xo), this._computeDeviceClassItemsMemo = w(Qo), this._computeEntityMap = w(
      (e) => new Map(e.map((t) => [t.entity_id, t]))
    ), this._computeDeviceMap = w(
      (e) => new Map(e.map((t) => [t.id, t]))
    ), this._computeAreaMap = w(
      (e) => new Map(e.map((t) => [t.area_id, t]))
    ), this._computeGroupCandidatesMemo = w(
      (e, t, i, s, o) => {
    ...
    ), this._computeGroupResultsMemo = w(
      (e, t, i, s, o, n) => {
    ...
    if (typeof e == "number") {
      ...
      if (d) {
        ...
        s = tn(
          ...
          if (I(_.entity_id) === "climate") {
            const v = _.attributes.hvac_action;
            if (v !== void 0)
              return !["idle", "off"].includes(v);
          }
          return !Vt.includes(_.state);
        });
      } else
        i = [], s = [];
    } else {
  ...
  renderExtraTab(e) {
    var L, $, x;
    const { panel: t, icon: i, name: s, color: o, icon_css: n, background_color: a } = e, l = this.hass.states[t], r = this.getCustomizationForType(t), c = this._handleDomainAction(t), d = ee({
      hasHold: pt(
    ...
    }), u = (r == null ? void 0 : r.state_content) ?? "state", _ = (r == null ? void 0 : r.badge_mode) ?? this.badge_mode, v = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, C = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, f = {
      "--status-card-badge-color": v ? `var(--${v}-color)` : void 0,
      "--status-card-badge-text-color": C ? `var(--${C}-color)` : void 0
    }, m = se(
      ((L = r == null ? void 0 : r.styles) == null ? void 0 : L.button) || (($ = r == null ? void 0 : r.styles) == null ? void 0 : $.card),
      r
    ), b = { ...this._parsedGlobalCss, ...m }, V = (r == null ? void 0 : r._parsedIconCss) || G((x = r == null ? void 0 : r.styles) == null ? void 0 : x.icon), y = {
  ...
  renderGroupTab(e, t) {
    ...
    const n = e.group_id || `${this.hass.localize("component.group.entity_component._.name")} ${t + 1}`, a = e.group_icon || ts, l = $1(
      this._config,
      n,
      void 0,
      this._customizationIndexMemo(this._config.customization)
      ...
      void 0,
      this._customizationIndexMemo(this._config.customization)
    ), c = this.getCustomizationForType(n), d = this._handleGroupAction(n, t, o), h = ee({
      hasHold: pt(
      ...
      background_color: r,
      square: this._config.square
    }), _ = (c == null ? void 0 : c.badge_color) || this.badge_color || void 0, v = (c == null ? void 0 : c.badge_text_color) || this.badge_text_color || void 0, C = {
      "--status-card-badge-color": _ ? `var(--${_}-color)` : void 0,
      "--status-card-badge-text-color": v ? `var(--${v}-color)` : void 0
    }, f = se(
      ((L = c == null ? void 0 : c.styles) == null ? void 0 : L.button) || (($ = c == null ? void 0 : c.styles) == null ? void 0 : $.card),
      c
    ), m = { ...this._parsedGlobalCss, ...f }, b = (c == null ? void 0 : c._parsedIconCss) || G((x = c == null ? void 0 : c.styles) == null ? void 0 : x.icon), V = {
      ...this._parsedGlobalIconCss,
      ...b
    }, y = (c == null ? void 0 : c.badge_mode) ?? this.badge_mode;
    return g`
      <ha-tab-group-tab
        slot="nav"
        panel=${"group-" + t}
        ...
        style=${z(C)}
        data-badge=${Kt(
      y && o.length > 0 ? String(o.length) : void 0
    )}
      >
        <div
          class="entity ${ut(p)}"
  ...
  renderItemTab(e) {
    ...
    const l = $1(
      ...
      R(t, i)
    ), c = this._handleDomainAction(t, i), d = ee({
      hasHold: pt(
        (r == null ? void 0 : r.hold_action) ?? this._config.hold_action
      ),
      hasDoubleClick: pt(
    ...
    let _;
    this._shouldShowTotalNumbers(t, i) ? _ = `${s.length}/${o.length} ${oe(
      this.hass,
      this._config,
      t,
      i
    )}` : this._shouldShowTotalEntities(t, i) ? _ = `${o.length}` : _ = `${s.length} ${oe(
      this.hass,
      this._config,
      t,
      i
    )}`;
    const v = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, C = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, f = {
      "--status-card-badge-color": v ? `var(--${v}-color)` : void 0,
      "--status-card-badge-text-color": C ? `var(--${C}-color)` : void 0
    }, m = (r == null ? void 0 : r.badge_mode) ?? this.badge_mode, b = se(
      (($ = r == null ? void 0 : r.styles) == null ? void 0 : $.button) || ((x = r == null ? void 0 : r.styles) == null ? void 0 : x.card),
      r
    ), V = { ...this._parsedGlobalCss, ...b }, y = (r == null ? void 0 : r._parsedIconCss) || G((Z = r == null ? void 0 : r.styles) == null ? void 0 : Z.icon), L = {
      ...this._parsedGlobalIconCss,
      ...y
    };
    return g`
      <ha-tab-group-tab
        ...
        style=${z(f)}
        data-badge=${Kt(
      m && a.length > 0 ? String(a.length) : void 0
    )}
      >
        <div
          class="entity ${ut(h)}"
  ...
  render() {
    ...
    return g`
      ...
      (l) => {
        ...
        }, p = this._config.person_home_color, u = this._config.person_away_color, _ = this._config.person_home_icon || "mdi:home", v = this._config.person_away_icon || "mdi:home-export-outline", C = c ? u || "red" : p || "green", f = c ? v : _;
        return g`
                <ha-tab-group-tab
                  slot="nav"
                  panel=${l.entity_id}
                ...
                >
                  ${this.badge_mode ? g`<div
                        class="person-badge"
                        style=${z({
          "--status-card-badge-color": `var(--${C}-color)`,
                  ...
                  <div class="entity ${ut(d)}">
                    <div class="entity-icon" style=${z(h)}>
                      ${l.attributes.entity_picture ? g`<img
                            ...
                            style=${z(h)}
                          />` : (b = l.attributes.icon) != null && b.startsWith("M") ? g`<ha-svg-icon
                            class="center"
...
S([
  H()
], E.prototype, "badge_mode", 2);
S([
  H()
], E.prototype, "no_background", 2);
S([
  H()
], E.prototype, "badge_color", 2);
S([
  H()
], E.prototype, "badge_text_color", 2);
S([
  H()
...
S([
  H()
], E.prototype, "_shouldHideCard", 2);
S([
  H()
], E.prototype, "__registryEntities", 2);
S([
  H()
], E.prototype, "__registryDevices", 2);
S([
  H()
], E.prototype, "__registryAreas", 2);
S([
  H()
], E.prototype, "__registryFetchInProgress", 2);
S([
  H()
], E.prototype, "_parsedGlobalCss", 2);
S([
  H()
], E.prototype, "_parsedGlobalIconCss", 2);
S([
  H()
], E.prototype, "_parsedGlobalCardCss", 2);
S([
  H()
], E.prototype, "_parsedGlobalNameCss", 2);
S([
  H()
], E.prototype, "_parsedGlobalStateCss", 2);
E = S([
  Gt("status-card")
], E);
function nn(e, t, i, s, o) {
  const n = (d, h, p) => $t(e, d, h, p), a = n({ name: "area" }), l = n({ name: "floor" }), r = n({ name: "name" }), c = n({ name: "state" });
  return [
    {
      name: "person",
      // @ts-ignore
...
let Y = class extends N {
  constructor() {
    ...
    ], this._activeTab = "config", this.computeLabel = w(
      (e, t, i) => $t(this.hass, e, t, i)
    ), this._filterInitialized = !1, this._lastFilter = {
      area: [],
      floor: [],
      label: []
    }, this._groupPreviousIds = /* @__PURE__ */ new Map(), this._schema = w(
      (e, t, i, s, o, n) => {
        switch (e) {
          case "appearance":
    ...
    }), this._buildToggleOptions = w(
      (e, t) => this._buildOptions("toggle", e, t)
    ), this._memoizedClassesForArea = w(
  ...
  async updated(e) {
    ...
    if (!(!this.hass || !this._config) && e.has("_config")) {
      if (this._updateAreaFloorInConfig(), (this._config.label_filter === !1 && this._config.label !== void 0 || Array.isArray(this._config.label) && this._config.label.length === 0) && (delete this._config.label, t = !0), this._config.hide_filter && !["entity", "label", "area"].includes(this._config.hide_filter)) {
        ...
        m && (this._config = { ...this._config, hide_filter: m }, t = !0);
      }
      ...
      const d = this._lastFilter.area, h = this._lastFilter.floor, p = this._lastFilter.label, u = !J(p, c), _ = !J(h, r), v = !J(d, l), C = this._config.content === void 0;
      if (v || _ || u || C) {
        const f = this.possibleToggleDomains, m = [];
        for (const V of Object.keys(F)) {
          const y = F[V];
          for (const L of Object.keys(y))
            L !== "on" && L !== "off" && m.push(`${V} - ${L}`);
          m.push(V);
        }
        const b = f.map((V) => this._normalizeContentEntry(V)).sort((V, y) => {
          const L = m.indexOf(V), $ = m.indexOf(y);
          return (L === -1 ? m.length : L) - ($ === -1 ? m.length : $);
        });
        this._config = {
          ...this._config,
          content: [...b]
      ...
      if (this._config.rulesets && Array.isArray(this._config.rulesets)) {
        const f = this._config.rulesets.filter(
          (y) => Object.keys(y).some(
            (L) => L !== "group_id" && L !== "group_icon" && L !== "group_status" && y[L] !== void 0 && y[L] !== ""
          )
        ).map((y) => y.group_id).filter((y) => y && y.length > 1);
        let m = Array.isArray(this._config.content) ? [...this._config.content] : [];
        m = m.filter((y) => !f.includes(y));
        ...
        m = [
          ...m.slice(0, V),
          ...f.filter((y) => !m.includes(y)),
          ...m.slice(V)
        ], J(m, this._config.content ?? []) || (this._config = {
          ...this._config,
          content: m
        }, t = !0);
      }
      if (!J(s, o)) {
        let f = [...a];
        o.forEach((m) => {
          f.includes(m) || f.unshift(m);
        }), f = f.filter(
          (m) => !m.includes(".") || o.includes(m)
        ), J(f, a) || (this._config = {
          ...this._config,
          content: f
        }, t = !0);
      ...
      if (!J(n, a)) {
        let f = [...o];
        f = f.filter((m) => a.includes(m)), J(f, o) || (this._config = {
          ...this._config,
          extra_entities: f
        }, t = !0);
      }
  ...
  _classesForArea(e, t, i, s, o, n) {
    var p;
    const a = ((p = this._config) == null ? void 0 : p.extra_entities) || [], l = H1(
      s,
      o,
      n,
      this.hass.states,
    ...
    for (const u in l) {
      ...
      ["binary_sensor", "cover", "switch"].includes(u) ? _.forEach((v) => {
        const C = v.attributes.device_class;
        C && c.add(`${u} - ${C}`);
      }) : r.add(u);
    }
    const d = [];
    ...
    return [...r, ...h, ...a].sort(
      (u, _) => {
        const v = d.indexOf(u), C = d.indexOf(_);
        return (v === -1 ? d.length : v) - (C === -1 ? d.length : C);
      }
    );
  }
  _buildOptions(e, t, i) {
  ...
  _renderSubElementEditor(e, t, i) {
    var r, c, d, h, p, u, _;
    const s = `_subElementEditor${e.charAt(0).toUpperCase() + e.slice(1)}`, o = this[s], n = ((d = (c = (r = this._config) == null ? void 0 : r.customization) == null ? void 0 : c[(o == null ? void 0 : o.index) ?? 0]) == null ? void 0 : d.type) ?? "unknown", a = this._labelForTypePair(n), l = ((p = (h = this._config) == null ? void 0 : h.rulesets) == null ? void 0 : p.some((v) => v.group_id === n)) ?? !1;
    return g`
      <div class="header">
  ...
  _groupAllEntitiesByDomain() {
    ...
    const e = this.hass.entities || {}, t = this.hass.devices || {}, i = this.hass.areas || {}, s = {
      ...
      hiddenEntities: ((m = this._config) == null ? void 0 : m.hidden_entities) ?? []
    }, o = H1(
      e,
      t,
      i,
      ...
      (y) => I(y.entity_id) === "person"
    );
    if (n.length > 0) {
      const y = o.person || [], L = new Set(y.map((x) => x.entity_id)), $ = n.filter(
        (x) => !L.has(x.entity_id)
      );
      o.person = [...y, ...$];
    }
    const a = Object.fromEntries(
      Object.entries(o).map(([y, L]) => [
        y,
        L.map(($) => $.entity_id)
      ])
    ), l = this._hiddenEntitiesByDomain(), r = ((V = this.hass) == null ? void 0 : V.states) || {}, c = Array.from(
      /* @__PURE__ */ new Set([...Object.keys(a), ...Object.keys(l)])
    ).filter((y) => [...X, "person"].includes(y)), d = Pt(
      r,
      this.hass.locale.language
    );
    return c.sort((y, L) => y.localeCompare(L)).map((y) => {
      const L = /* @__PURE__ */ new Set([
        ...a[y] || [],
        ...l[y] || []
      ]);
      return { domain: y, entities: Array.from(L).sort(d) };
    });
  }
  _domainLabel(e) {
    var t, i;
  ...
  _hiddenEntitiesByDomain() {
    ...
    const i = this.hass.entities || {}, s = this.hass.devices || {}, o = (p = this.hass) != null && p.areas ? Object.values(this.hass.areas) : [], n = (u = this._config) == null ? void 0 : u.area, a = (_ = this._config) == null ? void 0 : _.floor, l = (v = this._config) == null ? void 0 : v.label, r = n ? Array.isArray(n) ? n : [n] : [], c = a ? Array.isArray(a) ? a : [a] : [], d = l ? Array.isArray(l) ? l : [l] : [];
    for (const C of t) {
      const f = I(C);
      if (![...X, "person"].includes(f)) continue;
      const m = i[C], b = m != null && m.device_id ? s[m.device_id] : void 0;
      if (((m == null ? void 0 : m.area_id) != null || (b == null ? void 0 : b.area_id) != null) && !(d.length && !(Array.isArray(m == null ? void 0 : m.labels) && m.labels.some((L) => d.includes(L)) || Array.isArray(b == null ? void 0 : b.labels) && b.labels.some((L) => d.includes(L)))) && !(r.length && !(m != null && m.area_id && r.includes(m.area_id) || b != null && b.area_id && r.includes(b.area_id)))) {
        if (c.length) {
          const y = (m == null ? void 0 : m.area_id) && o.some(
            ($) => $.area_id === m.area_id && $.floor_id && c.includes($.floor_id)
          ), L = (b == null ? void 0 : b.area_id) && o.some(
            ($) => $.area_id === b.area_id && $.floor_id && c.includes($.floor_id)
          );
          if (!y && !L) continue;
        }
        e[f] || (e[f] = []), e[f].push(C);
