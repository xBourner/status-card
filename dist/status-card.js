 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: B1, defineProperty: F1, getOwnPropertyDescriptor: U1, getOwnPropertyNames: N1, getOwnPropertySymbols: G1, getPrototypeOf: q1 } = Object, X = globalThis, ye = X.trustedTypes, W1 = ye ? ye.emptyScript : "", Rt = X.reactiveElementPolyfillSupport, _t = (e, t) => e, xt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? W1 : null;
      break;
  ...
  return i;
} }, le = (e, t) => !B1(e, t), ve = { attribute: !0, type: String, converter: xt, reflect: !1, useDefault: !1, hasChanged: le };
...
lt.elementStyles = [], lt.shadowRootOptions = { mode: "open" }, lt[_t("elementProperties")] = /* @__PURE__ */ new Map(), lt[_t("finalized")] = /* @__PURE__ */ new Map(), Rt == null || Rt({ ReactiveElement: lt }), (X.reactiveElementVersions ?? (X.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const gt = globalThis, zt = gt.trustedTypes, be = zt ? zt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, b1 = "$lit$", J = `lit$${Math.random().toFixed(9).slice(2)}$`, L1 = "?" + J, K1 = `<${L1}>`, at = document, Ct = () => at.createComment(""), yt = (e) => e === null || typeof e != "object" && typeof e != "function", de = Array.isArray, J1 = (e) => de(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Bt = `[ 	
\f\r]`, pt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Le = /-->/g, Ae = />/g, et = RegExp(`>|${Bt}(?:([^\\s"'>=/]+)(${Bt}*=${Bt}*(?:[^ 	
...
const X1 = (e, t) => {
  ...
  let o, n = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = pt;
  for (let c = 0; c < i; c++) {
    const r = e[c];
    let l, d, h = -1, f = 0;
    for (; f < r.length && (a.lastIndex = f, d = a.exec(r), d !== null); ) f = a.lastIndex, a === pt ? d[1] === "!--" ? a = Le : d[1] !== void 0 ? a = Ae : d[2] !== void 0 ? (A1.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = et) : d[3] !== void 0 && (a = et) : a === et ? d[0] === ">" ? (a = o ?? pt, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, l = d[1], a = d[3] === void 0 ? et : d[3] === '"' ? Ve : He) : a === Ve || a === He ? a = et : a === Le || a === Ae ? a = pt : (a = et, o = void 0);
    const u = a === et && e[c + 1].startsWith("/>") ? " " : "";
    n += a === pt ? r + K1 : h >= 0 ? (s.push(l), r.slice(0, h) + b1 + r.slice(h) + J + u) : r + J + (h === -2 ? c : u);
  }
...
class vt {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    if (this.el = vt.createElement(l, s), st.currentNode = this.el.content, i === 2 || i === 3) {
    ...
    for (; (o = st.nextNode()) !== null && r.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(b1)) {
          ...
          r.push({ type: 1, index: n, name: _[2], strings: u, ctor: _[1] === "." ? ti : _[1] === "?" ? ei : _[1] === "@" ? ii : Dt }), o.removeAttribute(h);
...
function dt(e, t, i = e, s) {
  ...
  return (o == null ? void 0 : o.constructor) !== n && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), n === void 0 ? o = void 0 : (o = new n(e), o._$AT(e, i, s)), s !== void 0 ? (i._$Co ?? (i._$Co = []))[s] = o : i._$Cl = o), o !== void 0 && (t = dt(e, o._$AS(e, t.values), o, s)), t;
}
let Q1 = class {
  constructor(t, i) {
  ...
  u(t) {
    ...
    for (; r !== void 0; ) {
      if (a === r.index) {
        let l;
        r.type === 2 ? l = new ut(n, n.nextSibling, this, t) : r.type === 1 ? l = new r.ctor(n, r.name, r.strings, this, t) : r.type === 6 && (l = new si(n, this, t)), this._$AV.push(l), r = s[++c];
      }
...
class ut {
  ...
  _$AI(t, i = this) {
    t = dt(this, t, i), yt(t) ? t === S || t == null || t === "" ? (this._$AH !== S && this._$AR(), this._$AH = S) : t !== this._$AH && t !== B && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : J1(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== S && yt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(at.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
    const { values: i, _$litType$: s } = t, o = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = vt.createElement(H1(s.h, s.h[0]), this.options)), s);
  ...
  _$AC(t) {
    ...
    return i === void 0 && $e.set(t.strings, i = new vt(t)), i;
  }
  k(t) {
    de(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let s, o = 0;
    for (const n of t) o === i.length ? i.push(s = new ut(this.O(Ct()), this.O(Ct()), this, this.options)) : s = i[o], s._$AI(n), o++;
...
class Dt {
  ...
  _$AI(t, i = this, s, o) {
    ...
    let a = !1;
    if (n === void 0) t = dt(this, t, i, 0), a = !yt(t) || t !== this._$AH && t !== B, a && (this._$AH = t);
    else {
      const c = t;
      let r, l;
      for (t = n[0], r = 0; r < n.length - 1; r++) l = dt(this, c[s + r], i, r), l === B && (l = this._$AH[r]), a || (a = !yt(l) || l !== this._$AH[r]), l === S ? t = S : t !== S && (t += (l ?? "") + n[r + 1]), this._$AH[r] = l;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const oi = { I: ut }, Ft = gt.litHtmlPolyfillSupport;
Ft == null || Ft(vt, ut), (gt.litHtmlVersions ?? (gt.litHtmlVersions = [])).push("3.3.1");
const ni = (e, t, i) => {
  const s = (i == null ? void 0 : i.renderBefore) ?? t;
  let o = s._$litPart$;
  if (o === void 0) {
    const n = (i == null ? void 0 : i.renderBefore) ?? null;
    s._$litPart$ = o = new ut(t.insertBefore(Ct(), n), n, void 0, i ?? {});
  }
  return o._$AI(e), o;
};
/**
...
var y1;
R._$litElement$ = !0, R.finalized = !0, (y1 = ot.litElementHydrateSupport) == null || y1.call(ot, { LitElement: R });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: ci } = oi, Me = () => document.createComment(""), ft = (e, t, i) => {
  var n;
...
const we = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    ...
    else if (c[h] === a[_]) r[_] = it(o[h], n[_]), ft(e, r[_ + 1], o[h]), h++, _--;
    else if (c[f] === a[u]) r[u] = it(o[f], n[u]), ft(e, o[h], o[f]), f--, u++;
    else if (l === void 0 && (l = we(a, u, _), d = we(c, h, f)), l.has(c[h])) if (l.has(c[f])) {
      const y = d.get(a[u]), m = y !== void 0 ? o[y] : null;
      if (m === null) {
        const p = ft(e, o[h]);
        it(p, n[u]), r[u] = p;
      } else r[u] = it(m, n[u]), ft(e, o[h], m), o[y] = null;
      u++;
    } else Nt(o[f]), f--;
    else Nt(o[h]), h++;
    for (; u <= _; ) {
  ...
  bind(t, i = {}) {
    t.actionHandler && St(i, t.actionHandler.options) || (t.actionHandler && (t.removeEventListener("touchstart", t.actionHandler.start), t.removeEventListener("touchend", t.actionHandler.end), t.removeEventListener("touchcancel", t.actionHandler.end), t.removeEventListener("mousedown", t.actionHandler.start), t.removeEventListener("click", t.actionHandler.end), t.removeEventListener(
      ...
      if (s.currentTarget !== s.target || s.type === "touchcancel" || s.type === "touchend" && this.cancelled)
        return;
      const o = s.target;
      s.cancelable && s.preventDefault(), i.hasHold && (clearTimeout(this.timer), this.timer = void 0), i.hasHold && this.held ? k(o, "action", { action: "hold" }) : i.hasDoubleClick ? s.type === "click" && s.detail < 2 || !this.dblClickTimeout ? this.dblClickTimeout = window.setTimeout(() => {
        this.dblClickTimeout = void 0, k(o, "action", { action: "tap" });
      }, 250) : (clearTimeout(this.dblClickTimeout), this.dblClickTimeout = void 0, k(o, "action", { action: "double_tap" })) : k(o, "action", { action: "tap" });
...
const oo = () => {
  ...
  k(e, "hass-action", { config: i, action: s });
};
function Mt(e) {
...
function M1(e, t, i, s, o) {
  ...
  return Object.values(e).filter((p) => {
    ...
    if (v === "update")
      return !p.hidden;
    const g = p.device_id ? y.get(p.device_id) : void 0;
    ...
    return h.size && (p.area_id && h.has(p.area_id) || g && g.area_id && h.has(g.area_id)) || (D = p.labels) != null && D.some((Z) => f.has(Z)) || u.has(p.entity_id) ? !1 : !p.hidden;
  }).map((p) => p.entity_id);
}
function w1(e, t) {
  const i = {};
...
const me = class me extends R {
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return n.sort((r, l) => {
            ...
            if (d !== h) return d - h;
            const f = nt(r.entity_id), u = nt(l.entity_id), _ = this.hass ? F(this.hass, r.state, f) : r.state, y = this.hass ? F(this.hass, l.state, u) : l.state, m = (_ || "").localeCompare(y || "");
  ...
  _getPopupCardConfig(t) {
    var y, m, p, v;
    const i = this.card, s = nt(t.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (v = (p = (m = (y = this.hass) == null ? void 0 : y.states) == null ? void 0 : m[t.entity_id]) == null ? void 0 : p.attributes) == null ? void 0 : v.device_class, a = I(o, n), c = typeof (i == null ? void 0 : i.getCustomizationForType) == "function" ? i.getCustomizationForType(a) : void 0, r = c == null ? void 0 : c.popup_card, l = r && typeof r.type == "string" && r.type || "tile", d = l === "tile" ? uo[s] ?? {} : {};
    let h = {};
  ...
  render() {
    ...
    ), y = ((x = n == null ? void 0 : n._config) == null ? void 0 : x.ungroupAreas) === !0 || ((D = n == null ? void 0 : n._config) == null ? void 0 : D.ungroup_areas) === !0 || ((Z = n == null ? void 0 : n._config) == null ? void 0 : Z.area_grouping) !== void 0 && ((N = n == null ? void 0 : n._config) == null ? void 0 : N.area_grouping) === !1, m = _.length ? Math.max(..._.map(([, L]) => L.length)) : 0, p = y ? Math.min(t, Math.max(1, d.length)) : Math.min(t, Math.max(1, m)), v = I(i, s), g = typeof (n == null ? void 0 : n.getCustomizationForType) == "function" ? n.getCustomizationForType(v) : void 0, b = (g == null ? void 0 : g.invert) === !0;
    return C`
      <ha-dialog
        .open=${this.open}
        hideActions
      ...
      "ui.panel.lovelace.editor.card.entities.name"
        ...
        <div class="dialog-content scrollable">
          ${(jt = this.card) != null && jt.list_mode ? y ? C`
...
function Lt(e, t, i) {
  return t ? (i || D1(e.customization)).get(t.toLowerCase()) : void 0;
}
...
const Ao = (e, t, i, s) => s ? [] : Object.values(e).filter(
  ...
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    const r = s.indexOf(n), l = r >= 0 ? r : 0, d = k1(
      e,
      n,
      void 0,
      a,
...
let M = class extends R {
  constructor() {
    ...
    ), this._customizationIndexMemo = H(D1), this._computePersonIdsMemo = H(Ao), this._mapPersonIdsToStatesMemo = H(
      (e, t) => Ho(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
  ...
  _shouldShowTotalEntities(e, t) {
    ...
    const i = I(e, t), s = this.getCustomizationForType(i);
  ...
  _isOn(e, t) {
    const i = this._baseEntities(e, t), s = I(e, t), o = this.getCustomizationForType(s), n = (o == null ? void 0 : o.invert) === !0;
    return i.filter((a) => {
      if (e === "climate") {
  ...
  renderExtraTab(e) {
    ...
    }), u = (r == null ? void 0 : r.state_content) ?? void 0, _ = (r == null ? void 0 : r.badge_mode) ?? this.badge_mode, y = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, m = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, p = {
  ...
  renderItemTab(e) {
    ...
    const y = (r == null ? void 0 : r.badge_color) || this.badge_color || void 0, m = (r == null ? void 0 : r.badge_text_color) || this.badge_text_color || void 0, p = {
      "--status-card-badge-color": y ? `var(--${y}-color)` : void 0,
      "--status-card-badge-text-color": m ? `var(--${m}-color)` : void 0
    }, v = (r == null ? void 0 : r.badge_mode) ?? this.badge_mode;
    return C`
      <ha-tab-group-tab
        slot="nav"
        panel=${i || t}
  ...
  render() {
    ...
    return C`
      <ha-card>
        <ha-tab-group without-scroll-controls class=${mt(a)}>
      ...
      (c) => {
        ...
        }, f = this._config.person_home_color, u = this._config.person_away_color, _ = this._config.person_home_icon || "mdi:home", y = this._config.person_away_icon || "mdi:home-export-outline", m = l ? u || "red" : f || "green", p = l ? y : _;
        return C`
                <ha-tab-group-tab
                  slot="nav"
                  panel=${c.entity_id}
  ...
  render() {
    ...
    return C`
      ...
      "ui.panel.lovelace.editor.card.tile.appearance"
        ...
        >
          ${this.hass.localize("ui.panel.lovelace.editor.card.tile.actions") || "Actions"}
        </ha-tab-group-tab>
      </ha-tab-group>
      <ha-form
        .hass=${this.hass}
...
let G = class extends R {
  constructor() {
    super(...arguments), this._subElementEditorDomain = void 0, this._subElementEditorEntity = void 0, this.rulesets = [
      ...
      this._config = {
        ...this._config || {},
        hidden_entities: i
      }, k(this, "config-changed", { config: { ...this._config } });
    };
  }
  setConfig(e) {
    this._config = {
  ...
  _updateAreaFloorInConfig() {
    ...
    this._config.filter === "area" && this._config.floor !== void 0 ? (delete this._config.floor, k(this, "config-changed", { config: { ...this._config } })) : this._config.filter === "floor" && this._config.area !== void 0 && (delete this._config.area, k(this, "config-changed", { config: { ...this._config } }));
  }
  async updated(e) {
    super.updated(e);
    let t = !1;
    if (!(!this.hass || !this._config) && e.has("_config")) {
      ...
      if (!W(d, c) || _ || u) {
        ...
        const v = m.map((g) => this._normalizeContentEntry(g)).sort((g, b) => {
      ...
      t && (k(this, "config-changed", { config: { ...this._config } }), this.requestUpdate());
    }
  }
  getGroupSchema(e) {
    return [
  ...
  _classesForArea(e, t, i, s, o, n) {
    ...
    for (const u in c) {
      if (!Object.prototype.hasOwnProperty.call(c, u))
        continue;
      const _ = c[u];
      ["binary_sensor", "cover", "switch"].includes(u) ? _.forEach((y) => {
    ...
    return [...r, ...h, ...a].sort(
      (u, _) => {
        const y = d.indexOf(u), m = d.indexOf(_);
  ...
  _itemChanged(e, t, i) {
    ...
    if (s != null) {
      ...
      o[s] = e.detail, k(this, "config-changed", {
  ...
  _customizationChanged(e, t) {
    e.stopPropagation(), !(!this._config || !this.hass) && k(this, "config-changed", {
      config: {
        ...this._config,
  ...
  _hiddenEntitiesByDomain() {
    ...
    const i = this.hass.entities || {}, s = this.hass.devices || {}, o = (f = this.hass) != null && f.areas ? Object.values(this.hass.areas) : [], n = (u = this._config) == null ? void 0 : u.area, a = (_ = this._config) == null ? void 0 : _.floor, c = (y = this._config) == null ? void 0 : y.label, r = n ? Array.isArray(n) ? n : [n] : [], l = a ? Array.isArray(a) ? a : [a] : [], d = c ? Array.isArray(c) ? c : [c] : [];
    for (const m of t) {
      const p = nt(m);
      if (!K.includes(p)) continue;
      const v = i[m], g = v != null && v.device_id ? s[v.device_id] : void 0;
      if (((v == null ? void 0 : v.area_id) != null || (g == null ? void 0 : g.area_id) != null) && !(d.length && !(Array.isArray(v == null ? void 0 : v.labels) && v.labels.some((x) => d.includes(x)) || Array.isArray(g == null ? void 0 : g.labels) && g.labels.some((x) => d.includes(x)))) && !(r.length && !(v != null && v.area_id && r.includes(v.area_id) || g != null && g.area_id && r.includes(g.area_id)))) {
        if (l.length) {
          const A = (v == null ? void 0 : v.area_id) && o.some(
            (D) => D.area_id === v.area_id && D.floor_id && l.includes(D.floor_id)
          ), x = (g == null ? void 0 : g.area_id) && o.some(
            (D) => D.area_id === g.area_id && D.floor_id && l.includes(D.floor_id)
          );
          if (!A && !x) continue;
        }
        e[p] || (e[p] = []), e[p].push(m);
