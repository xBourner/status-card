...
const j1 = (e) => new y1(typeof e == "string" ? e : e + "", void 0, ce), ht = (e, ...t) => {
...
class ut {
  ...
  _$AI(t, i = this) {
    t = dt(this, t, i), vt(t) ? t === S || t == null || t === "" ? (this._$AH !== S && this._$AR(), this._$AH = S) : t !== this._$AH && t !== B && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : J1(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class Dt {
  ...
  _$AI(t, i = this, s, o) {
    ...
    let a = !1;
    if (n === void 0) t = dt(this, t, i, 0), a = !vt(t) || t !== this._$AH && t !== B, a && (this._$AH = t);
    else {
      const c = t;
      let r, l;
      for (t = n[0], r = 0; r < n.length - 1; r++) l = dt(this, c[s + r], i, r), l === B && (l = this._$AH[r]), a || (a = !vt(l) || l !== this._$AH[r]), l === S ? t = S : t !== S && (t += (l ?? "") + n[r + 1]), this._$AH[r] = l;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
Ft == null || Ft(yt, ut), (gt.litHtmlVersions ?? (gt.litHtmlVersions = [])).push("3.3.1");
const ni = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    ...
    for (; h <= f && u <= _; ) if (o[h] === null) h++;
      ...
      if (m === null) {
        const p = ft(e, o[h]);
        it(p, n[u]), r[u] = p;
      } else r[u] = it(m, n[u]), ft(e, o[h], m), o[v] = null;
      u++;
    } else Nt(o[f]), f--;
    else Nt(o[h]), h++;
    for (; u <= _; ) {
    ...
    features: [
      {
        ...
        operation_modes: ["eco", "electric", "performance", "high_demand", "heat_pump", "gas", "off"]
      }
    ]
  }
};
      ...
      if (((y == null ? void 0 : y.area_id) != null || (g == null ? void 0 : g.area_id) != null) && !(d.length && !(Array.isArray(y == null ? void 0 : y.labels) && y.labels.some((x) => d.includes(x)) || Array.isArray(g == null ? void 0 : g.labels) && g.labels.some((x) => d.includes(x)))) && !(r.length && !(y != null && y.area_id && r.includes(y.area_id) || g != null && g.area_id && r.includes(g.area_id)))) {
        if (l.length) {
          const A = (y == null ? void 0 : y.area_id) && o.some(
            (D) => D.area_id === y.area_id && D.floor_id && l.includes(D.floor_id)
